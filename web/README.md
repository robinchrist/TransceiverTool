...
- Edit scalar fields, enums, flags, nested objects, and alternative representations directly
  from the repository's schemas. Representation changes initialize that alternative; Undo
  restores the previous value. Unknown JSON properties survive ordinary visual edits.
