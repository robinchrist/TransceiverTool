...
namespace TransceiverTool::Standards::SFF8636 {
    ...
    struct Option_Values_Byte_195 {
        ...
        // Rate select is implemented as defined in 6.2.7. If the bit is set to 1 then refer to that section for
        // multi-rate operation description.
        bool rate_select_implemented_bit_5;

        // Tx_Disable is implemented and disables the serial output as defined by the relevant transmitter
        // specification.
