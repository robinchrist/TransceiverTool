...
namespace TransceiverTool::Standards::SFF8472 {
    ...
    inline const std::array<PhysicalDeviceIdentifierAssignedValue, 4> PhysicalDeviceIdentifierAssignedValues{{
        ...
        {PhysicalDeviceIdentifier::Module_soldered_to_motherboard_ex_SFF,
         "Module soldered to motherboard (ex: SFF)",
         0x02},
        {PhysicalDeviceIdentifier::SFP_or_SFP_plus, "SFP or SFP+", 0x03}  // 0x04 - 0x7F: Not used by this specification
                                                                          // (Reserved) 0x80 - 0xFF: Vendor Specific
    }};
