...
namespace TransceiverTool::Standards::SFF8024 {
    ...
    inline const std::array<TransceiverConnectorTypeAssignedValue, 23> TransceiverConnectorTypeAssignedValues{{
        ...
        {TransceiverConnectorType::Fibre_Channel_Style_1_copper_connector,
         "Fibre Channel Style 1 copper connector",
         0x02},
        {TransceiverConnectorType::Fibre_Channel_Style_2_copper_connector,
         "Fibre Channel Style 2 copper connector",
         0x03},
        {TransceiverConnectorType::BNC_TNC_Bayonet_Threaded_Neill_Concelman,
        ...
        {TransceiverConnectorType::MT_RJ_Mechanical_Transfer_Registered_Jack,
        ...
        {TransceiverConnectorType::HSSDC_II_High_Speed_Serial_Data_Connector,
        ...
        {TransceiverConnectorType::SN_previously_Mini_CS_optical_connector,
