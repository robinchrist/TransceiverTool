...
namespace TransceiverTool::Standards::SFF8472 {
    ...
    inline const std::array<RateIdentifierAssignedValue, 11> RateIdentifierAssignedValues{{
        ...
        // 05h Unspecified *
        {RateIdentifier::SFF_8431_8_4_2G_Independent_Rx_and_Tx_Rate_select,
         "SFF-8431 (8/4/2G Independent Rx & Tx Rate_select)",
         0x06},
        // 07h Unspecified *
        {RateIdentifier::FC_PI_5_16_8_4G_Rx_Rate_select_only,
         "FC-PI-5 (16/8/4G Rx Rate_select only) High=16G only, Low=8G/4G",
         0x08},
        // 09h Unspecified *
        {RateIdentifier::FC_PI_5_16_8_4G_Independent_Rx_Tx_Rate_select,
         "FC-PI-5 (16/8/4G Independent Rx, Tx Rate_select) High=16G only, Low=8G/4G",
         0x0A},
        // 0Bh Unspecified *
        {RateIdentifier::FC_PI_6_32_16_8G_Independent_Rx_Tx_Rate_Select,
         "FC-PI-6 (32/16/8G Independent Rx, Tx Rate_Select) High=32G only, Low = 16G/8G",
         0x0C},
        // 0Dh Unspecified *
        {RateIdentifier::_10_8G_Rx_and_Tx_Rate_Select,
         "10/8G Rx and Tx Rate_Select controlling the operation or locking modes of the internal signal conditioner, "
         "retimer or CDR",
         0x0E},
        // 0Fh Unspecified *
        {RateIdentifier::FC_PI_7_64_32_16G_Independent_Rx_Tx_Rate_Select,
         "FC-PI-7 (64/32/16G Independent Rx, Tx Rate Select) High = 32GFC and 64GFC, Low = 16GFC",
         0x10},
        // 11h Unspecified *
        // 12h-1Fh Reserved
        {RateIdentifier::Rate_select_based_on_PMDs_as_defined_by_A0h,
