...
namespace TransceiverTool::Standards::SFF8472 {
    struct SFF8472_LowerA0h {
        ...
        // Link length supported for 50um OM4 fiber, units of 10 m. Alternatively, copper or direct attach cable, units
        // of m
        unsigned char byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m;

        // Byte 19: Length (OM3) or Cable length, additional
        // Link length supported for 50 um OM3 fiber, units of 10 m. Alternatively, copper or direct attach cable
        // multiplier and base value
        ...
        // If address 12 is not set to FFh, the upper signaling rate limit at which the transceiver still meets its
        // specifications (Signaling Rate, max) is specified in units of 1% above the nominal signaling rate. If address
        // 12 is set to FFh, the nominal signaling rate (Signaling Rate, nominal) is given in this field in units of 250
        // MBd
        ...
        // If address 12 is not set to FFh, the lower signaling rate limit at which the transceiver still meets its
        // specifications (Signaling Rate, min) is specified in units of 1% below the nominal bit rate. If address 12 is
        // set to FFh, the limit range of signaling rates specified in units of +/- 1% around the nominal signaling
        // rate.
