...
namespace TransceiverTool::Standards::SFF8636 {
    ...
    struct Enhanced_Options {
        ...
        // Initialization Complete Flag implemented. This flag was introduced in rev 2.5. When this bit is 1, the
        // initialization
        //  complete flag at Byte 6 bit 0 is implemented independently of t_init. When this bit is 0, the initialization
        //  complete flag is either not implemented or if implemented has a response time less than t_init, max as
        //  specified for the module
        bool initialization_complete_flag_implemented_bit_4;

        // Rate Selection Declaration: When this Declaration bit is 0 the free side device does not support rate
        // selection. When this Declaration bit is 1, rate selection is implemented using extended rate selection.
        // See 6.2.7.2
