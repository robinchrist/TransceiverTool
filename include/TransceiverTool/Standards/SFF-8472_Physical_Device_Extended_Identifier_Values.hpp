...
namespace TransceiverTool::Standards::SFF8472 {
    ...
    inline const std::array<PhysicalDeviceExtendedIdentifierAssignedValue, 8>
        PhysicalDeviceExtendedIdentifierAssignedValues{{
            {PhysicalDeviceExtendedIdentifier::definition_is_not_specified,
             "GBIC definition is not specified or the GBIC definition is not compliant with a defined MOD_DEF. See "
            ...
            {PhysicalDeviceExtendedIdentifier::defined_by_2_wire_interface_id_only,
