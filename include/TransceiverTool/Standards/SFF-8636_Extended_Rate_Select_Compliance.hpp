...
namespace TransceiverTool::Standards::SFF8636 {
    ...
    enum class Extended_Rate_Select_Compliance_Bit_1_0 {
        RESERVED_OR_NOT_IMPLEMENTED_0b00,
    ...
    inline const std::array<Extended_Rate_Select_Compliance_Bit_1_0_string, 4>
        Extended_Rate_Select_Compliance_Bit_1_0_strings{{
            {Extended_Rate_Select_Compliance_Bit_1_0::RESERVED_OR_NOT_IMPLEMENTED_0b00,
             "Reserved / Not Implemented? (00b)",
             0b00},
