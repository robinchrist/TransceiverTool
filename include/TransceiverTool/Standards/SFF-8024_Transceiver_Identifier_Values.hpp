...
namespace TransceiverTool::Standards::SFF8024 {
    ...
    inline const std::array<TransceiverReferenceAssignedValue, 38> TransceiverReferenceAssignedValues{{
        ...
        {TransceiverReference::Module_connector_soldered_to_motherboard_using_SFF_8472,
         "Module/connector soldered to motherboard (using SFF-8472)",
         0x02},
        {TransceiverReference::SFP_SFP_plus_SFP28_and_later_with_SFF_8472_management_interface,
         "SFP/SFP+/SFP28 and later with SFF-8472 management interface",
         0x03},
        ...
        {TransceiverReference::
             QSFP_plus_or_later_with_SFF_8636_or_SFF_8436_management_interface_SFF_8436_SFF_8635_SFF_8665_SFF_8685_et_al,
         "QSFP+ or later with SFF-8636 or SFF-8436 management interface (SFF-8436, SFF-8635, SFF-8665, SFF-8685 et "
         "al.)",
         0x0D},
        ...
        {TransceiverReference::QSFP28_or_later_with_SFF_8636_management_interface_SFF_8665_et_al,
        ...
        {TransceiverReference::Shielded_Mini_Multilane_HD_4X_Fanout_Cable,
         "Shielded Mini Multilane HD 4X Fanout Cable",
         0x14},
        {TransceiverReference::Shielded_Mini_Multilane_HD_8X_Fanout_Cable,
        ...
        {TransceiverReference::QSFP_DD_Double_Density_8X_Pluggable_Transceiver,
        ...
        {TransceiverReference::
             SFP_DD_Double_Density_2X_Pluggable_Transceiver_with_SFP_DD_Management_Interface_Specification,
         "SFP-DD Double Density 2X Pluggable Transceiver with SFP-DD Management Interface Specification",
         0x1A},
        {TransceiverReference::DSFP_Dual_Small_Form_Factor_Pluggable_Transceiver,
        ...
        {TransceiverReference::QSFP_plus_or_later_with_Common_Management_Interface_Specification_CMIS,
        ...
        {TransceiverReference::
         ...
         0x1F},
        {TransceiverReference::SFP_plus_and_later_with_Common_Management_Interface_Specification_CMIS,
         "SFP+ and later with Common Management Interface Specification (CMIS)",
         0x20},
        {TransceiverReference::OSFP_XD_with_Common_Management_interface_Specification_CMIS,
         "OSFP-XD with Common Management interface Specification (CMIS)",
         0x21},
        {TransceiverReference::OIF_ELSFP_with_Common_Management_interface_Specification_CMIS,
         "OIF-ELSFP with Common Management interface Specification (CMIS)",
         0x22},
        {TransceiverReference::CDFP_x4_PCIe_SFF_TA_1032_with_Common_Management_interface_Specification_CMIS,
         "CDFP (x4 PCIe) SFF-TA-1032 with Common Management interface Specification (CMIS)",
         0x23},
        {TransceiverReference::CDFP_x8_PCIe_SFF_TA_1032_with_Common_Management_interface_Specification_CMIS,
         "CDFP (x8 PCIe) SFF-TA-1032 with Common Management interface Specification (CMIS)",
         0x24},
        {TransceiverReference::CDFP_x16_PCIe_SFF_TA_1032_with_Common_Management_interface_Specification_CMIS,
