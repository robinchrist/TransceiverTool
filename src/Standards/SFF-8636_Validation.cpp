...
namespace TransceiverTool::Standards::SFF8636::Validation {
    ...
    void validateIdentifierValues(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_128_Identifier >= 0x26 && programming.byte_128_Identifier <= 0x7F) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 128 (\"Identifier\") value corresponds to \"Reserved\" range (SFF-8024 Rev 4.11 Table 4-1 "
                    "\"Identifier Values\"), value is {:#04x}",
                    programming.byte_128_Identifier
                )
            );
        }
        if(programming.byte_128_Identifier >= 0x80) {
            validationResult.warnings.push_back(
                fmt::format(
                    "Byte 128 (\"Identifier\") value corresponds to \"Vendor Specific\" range (SFF-8024 Rev 4.11 Table "
                    "4-1 \"Identifier Values\"), value is {:#04x}",
                    programming.byte_128_Identifier
                )
            );
        }
    ...
    void
    validateExtendedIdentifierValues(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_129_extended_identifier.power_class_bit_1_0 !=
               TransceiverTool::Standards::SFF8636::Extended_Identifier_Bit_1_0::POWER_CLASSES_1_TO_4_0b00 &&
           programming.byte_129_extended_identifier.power_class_bit_7_6 !=
               TransceiverTool::Standards::SFF8636::Extended_Identifier_Bit_7_6::POWER_CLASS_4_TO_7_0b11) {
            validationResult.errors.push_back(
                // TODO: add bits value present in programming to error message?
                fmt::format(
                    "Byte 129 (\"Extended Identifier\") inconsistent values: value bits 1-0 indicate power class "
                    "\"{}\", but bits 7-6 indicates \"{}\"",
                    getSFF8636_Extended_Identifier_Bit_1_0Info(
                        programming.byte_129_extended_identifier.power_class_bit_1_0
                    )
                        .description,
                    getSFF8636_Extended_Identifier_Bit_7_6Info(
                        programming.byte_129_extended_identifier.power_class_bit_7_6
                    )
                        .description
                )
    ...
    void validateConnectorTypes(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if((programming.byte_130_Connector_Type >= 0x0E && programming.byte_130_Connector_Type <= 0x1F) ||
    ...
    void validateSpecificationComplianceCodes(
        ...
        if(programming.byte_132_sonet_compliance_codes.reserved_bit_7 ||
           programming.byte_132_sonet_compliance_codes.reserved_bit_6 ||
           programming.byte_132_sonet_compliance_codes.reserved_bit_5 ||
           programming.byte_132_sonet_compliance_codes.reserved_bit_4 ||
           programming.byte_132_sonet_compliance_codes.reserved_bit_3) {
            validationResult.errors.push_back(
                fmt::format(
                    ...
                    "{:d}, Bit 5 {:d}, Bit 4 {:d}, Bit 3 {:d}",
                    programming.byte_132_sonet_compliance_codes.reserved_bit_7,
                    programming.byte_132_sonet_compliance_codes.reserved_bit_6,
                    programming.byte_132_sonet_compliance_codes.reserved_bit_5,
                    programming.byte_132_sonet_compliance_codes.reserved_bit_4,
                    programming.byte_132_sonet_compliance_codes.reserved_bit_3
        ...
        if(programming.byte_133_sas_sata_compliance_codes.reserved_bit_3 ||
           programming.byte_133_sas_sata_compliance_codes.reserved_bit_2 ||
           programming.byte_133_sas_sata_compliance_codes.reserved_bit_1 ||
           programming.byte_133_sas_sata_compliance_codes.reserved_bit_0) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 133 (\"SAS/SATA Compliance Codes\") value has at least one reserved bit set: Bit 3 {:d}, Bit "
                    "2 {:d}, Bit 1 {:d}, Bit 0 {:d}",
                    programming.byte_133_sas_sata_compliance_codes.reserved_bit_3,
                    programming.byte_133_sas_sata_compliance_codes.reserved_bit_2,
                    programming.byte_133_sas_sata_compliance_codes.reserved_bit_1,
                    programming.byte_133_sas_sata_compliance_codes.reserved_bit_0
                )
        ...
        if(programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_7 ||
           programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_6 ||
           programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_5 ||
           programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_4) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 134 (\"Gigabit Ethernet Compliance Codes\") value has at least one reserved bit set: Bit 7 "
                    "{:d}, Bit 6 {:d}, Bit 5 {:d}, Bit 4 {:d}",
                    programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_7,
                    programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_6,
                    programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_5,
                    programming.byte_134_gigabit_ethernet_compliance_codes.reserved_bit_4
                )
        ...
        if(programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_3 ||
           programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_2 ||
           programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_1 ||
           programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_0) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 136 (\"Fibre Channel Transmitter Technology\") value has at least one reserved bit set: Bit "
                    "3 {:d}, Bit 2 {:d}, Bit 1 {:d}, Bit 0 {:d}",
                    programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_3,
                    programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_2,
                    programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_1,
                    programming.byte_136_fibre_channel_transmitter_technology.reserved_bit_0
                )
    ...
    void validateEncodingValues(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_139_Encoding >= 0x09) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 139 (\"Encoding\") value corresponds to \"Reserved\" range (SFF-8024 Rev 4.11 Table 4-2 "
                    "\"Encoding Values\"), value is {:#04x}",
                    programming.byte_139_Encoding
                )
            );
        }
    }
    ...
    void validateNominalSignalingRate(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        // SFF-8636 Rev 2.11 Section 6.3.6 Nominal Signaling Rate (00h 140) & Table 6-26 Extended Baud Rate: Nominal
        // (Page 00h Byte 222)
        if(programming.byte_140_nominal_signaling_rate_in_100_mbaud == 0) {
            validationResult.warnings.push_back(fmt::format("Byte 140 (\"Nominal Signaling Rate\") value is 0"));
        }
        if(programming.byte_140_nominal_signaling_rate_in_100_mbaud == 0xFF) {
            if(programming.byte_222_extended_baud_rate_in_250_mbaud == 0) {
                validationResult.warnings.push_back(
                    fmt::format(
                        "Byte 140 (\"Nominal Signaling Rate\") value is 0xFF indicating a nominal baud rate > 25.4 "
                        "GBd, but Byte 222 (\"Extended Baud Rate: Nominal\") is zero"
                    )
                );
            } else {
                unsigned long nominalBaudRateFromByte222 =
                    (unsigned long)(programming.byte_222_extended_baud_rate_in_250_mbaud) * 250UL;

                if(nominalBaudRateFromByte222 < 25400) {
                    validationResult.warnings.push_back(
                        fmt::format(
                            "Byte 140 (\"Nominal Signaling Rate\") value is 0xFF indicating a nominal baud rate > 25.4 "
                            "GBd, but value from Byte 222 (\"Extended Baud Rate: Nominal\") is too small ({} MBd)",
                            nominalBaudRateFromByte222
                        )
                    );
                }
            }
    ...
    void validateExtendedRateSelectCompliance(
        const SFF8636_Upper00h& programming,
        common::ValidationResult& validationResult
    ) {
        // SFF-8636 Rev 2.11 Table 6-18 Extended Rate Select Compliance Tag Assignment (Page 00h Byte 141)
        if(programming.byte_141_extended_rate_select_compliance.reserved_bit_7 ||
           ...
           programming.byte_141_extended_rate_select_compliance.reserved_bit_4 ||
           programming.byte_141_extended_rate_select_compliance.reserved_bit_3 ||
           programming.byte_141_extended_rate_select_compliance.reserved_bit_2 ||
           programming.byte_141_extended_rate_select_compliance.rate_select_bits_1_0 ==
            ...
            validationResult.errors.push_back(
                fmt::format(
                    ...
                    programming.byte_141_extended_rate_select_compliance.reserved_bit_3,
                    programming.byte_141_extended_rate_select_compliance.reserved_bit_2,
                    TransceiverTool::Standards::SFF8636::getSFF8636_Extended_Rate_Select_Compliance_Bit_1_0Info(
                        programming.byte_141_extended_rate_select_compliance.rate_select_bits_1_0
                    )
                        .description
                )
            ...
            if(!std::isprint(programming.byte_148_163_vendor_name[index])) {
                validationResult.errors.push_back(
                    fmt::format(
                        ...
                        148 + index,
                        index,
                        programming.byte_148_163_vendor_name[index]
                    )
                );
            }
        }
    ...
    void validateExtendedModuleCodes(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_164_extended_module_codes.reserved_bit_7 ||
           programming.byte_164_extended_module_codes.reserved_bit_6) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 164 (\"Extended Module Codes\") value has at least one reserved bit set: Bit 7 {:d}, Bit 6 "
                    "{:d}",
                    programming.byte_164_extended_module_codes.reserved_bit_7,
                    programming.byte_164_extended_module_codes.reserved_bit_6
                )
            );
        }
                ...
                if(!std::isprint(programming.byte_168_183_vendor_pn[index])) {
                    validationResult.errors.push_back(
                        fmt::format(
                            ...
                            168 + index,
                            index,
                            programming.byte_168_183_vendor_pn[index]
                        )
                    );
                }
            }
                ...
                if(!std::isprint(programming.byte_184_185_vendor_rev[index])) {
                    validationResult.errors.push_back(
                        fmt::format(
                            ...
                            184 + index,
                            index,
                            programming.byte_184_185_vendor_rev[index]
                        )
                    );
                }
            }
    ...
    validateMaximumCaseTemperature(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_190_max_case_temperature == 70) {
            validationResult.warnings.push_back(
                fmt::format(
                    "Byte 190 (\"Maximum Case Temperature\") value is {:#04x} -> 70 deg C, but standards mandates "
                    "setting to 00h for 70 deg C and values other than 00h must only be used for maximum case "
                    "temperatures that are not 70 deg C",
    ...
    void validateExtendedSpecificationComplianceCodes(
        ...
        if(programming.byte_192_extended_specification_compliance_codes == 0x0A ||
           programming.byte_192_extended_specification_compliance_codes == 0x0F ||
           (programming.byte_192_extended_specification_compliance_codes >= 0x3B &&
            programming.byte_192_extended_specification_compliance_codes <= 0x3E) ||
           (programming.byte_192_extended_specification_compliance_codes >= 0x4D &&
            programming.byte_192_extended_specification_compliance_codes <= 0x7E) ||
           programming.byte_192_extended_specification_compliance_codes >= 0x82) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 192 (\"Extended Specification Compliance Codes\") value corresponds to \"Reserved\" range / "
    ...
    void validateOptionValues(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_193_option_values.reserved_bit_7) {
            validationResult.errors.push_back(fmt::format("Byte 193 (\"Option Values\") reserved bit 7 is set"));
        }
    }
                ...
                if(!std::isprint(programming.byte_196_211_vendor_sn[index])) {
                    validationResult.errors.push_back(
                        fmt::format(
                            ...
                            196 + index,
                            index,
                            programming.byte_196_211_vendor_sn[index]
                        )
                    );
                }
            }
    ...
    void validateDateCode(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(!std::isdigit(programming.byte_212_219_date_code.year_low_order_digits[0]) ||
           !std::isdigit(programming.byte_212_219_date_code.year_low_order_digits[1])) {
            validationResult.errors.push_back(
                fmt::format("Byte 212 / 213 (\"Date Code\", low order digits of the year) is not a number")
            );
        }
        // No need to parse: We checked that both characters are numbers [0-9] and all values are valid (year 2000 -
        // 2099)

        if(programming.byte_212_219_date_code.month_digits[0] <= 0x2F ||
           programming.byte_212_219_date_code.month_digits[0] >= 0x3A ||
           programming.byte_212_219_date_code.month_digits[1] <= 0x2F ||
           programming.byte_212_219_date_code.month_digits[1] >= 0x3A) {
            validationResult.errors.push_back(
                fmt::format("Byte 213 / 214 (\"Date Code\", digits of the month) is not a number")
            );
        } else {
            try {
                int digits_of_month = std::stoi(
                    std::string(
                        reinterpret_cast<char const*>(programming.byte_212_219_date_code.month_digits.data()), 2
                    )
                );
        ...
        if(programming.byte_212_219_date_code.day_digits[0] <= 0x2F ||
           programming.byte_212_219_date_code.day_digits[0] >= 0x3A ||
           programming.byte_212_219_date_code.day_digits[1] <= 0x2F ||
           programming.byte_212_219_date_code.day_digits[1] >= 0x3A) {
            validationResult.errors.push_back(
                fmt::format("Byte 215 / 216 (\"Date Code\", day of the month) is not a number")
            );
        } else {
            try {
                int digits_of_month = std::stoi(
            ...
            if(!std::isprint(programming.byte_212_219_date_code.lot_code[index])) {
                validationResult.errors.push_back(
                    fmt::format(
                        ...
                        218 + index,
                        index,
                        programming.byte_212_219_date_code.lot_code[index]
                    )
                );
            }
        }
    ...
    void
    validateDiagnosticMonitoringType(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        // SFF-8636 Rev 2.11 Section 6.3.27 Diagnostic Monitoring Type (00h 220)
        if(programming.byte_220_diagnostic_monitoring_type.reserved_bit_7 ||
           programming.byte_220_diagnostic_monitoring_type.reserved_bit_6 ||
           programming.byte_220_diagnostic_monitoring_type.reserved_bit_1 ||
           programming.byte_220_diagnostic_monitoring_type.reserved_bit_0) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 220 (\"Diagnostic Monitoring Type\") value has at least one reserved bit set: Bit 7 {:d}, "
                    "Bit 6 {:d}, Bit 1 {:d}, Bit 0 {:d}",
                    programming.byte_220_diagnostic_monitoring_type.reserved_bit_7,
                    programming.byte_220_diagnostic_monitoring_type.reserved_bit_6,
                    programming.byte_220_diagnostic_monitoring_type.reserved_bit_1,
                    programming.byte_220_diagnostic_monitoring_type.reserved_bit_0
                )
    ...
    void validateEnhancedOptions(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        if(programming.byte_221_enhanced_options.reserved_bit_7 ||
           programming.byte_221_enhanced_options.reserved_bit_6 ||
           programming.byte_221_enhanced_options.reserved_bit_5 ||
           programming.byte_221_enhanced_options.reserved_bit_2) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 221 (\"Enhanced Options\") value has at least one reserved bit set: Bit 7 {:d}, Bit 6 {:d}, "
                    "Bit 5 {:d}, Bit 2 {:d}",
                    programming.byte_221_enhanced_options.reserved_bit_7,
                    programming.byte_221_enhanced_options.reserved_bit_6,
                    programming.byte_221_enhanced_options.reserved_bit_5,
                    programming.byte_221_enhanced_options.reserved_bit_2
                )
    ...
    void validateExtendedBaudRate(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_222_extended_baud_rate_in_250_mbaud != 0 &&
           programming.byte_140_nominal_signaling_rate_in_100_mbaud != 0xFF) {
            validationResult.warnings.push_back(
                fmt::format(
                    "Byte 222 (\"Extended Baud Rate: Nominal\") is nonzero, but byte 140 (\"Nominal Signaling Rate\") "
                    "is not 0xFF"
                )
            );
        }
    ...
    validateRateSelectionConsistency(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        // Byte 195 bit 5) has a value of 0
        ...
        // values of 0 and 1 respectively and at least one of the bits in the Extended Rate Compliance byte (Page 00h
        // Byte 141) has a value of one, the free side device supports extended rate select.

        bool noSupportForRateSelectionConsistent =
            programming.byte_141_extended_rate_select_compliance.rate_select_bits_1_0 ==
                Extended_Rate_Select_Compliance_Bit_1_0::RESERVED_OR_NOT_IMPLEMENTED_0b00 &&
        ...
        if(!noSupportForRateSelectionConsistent && !supportForExtendedRateSelectionConsistent) {
            validationResult.errors.push_back(
                fmt::format(
                    "No consistent options for rate selection support - No Support for rate selection requires byte "
                    "141, bits 1-0 = 0b00, byte 195 bit 5 = 0, byte 221 bit 2 = 0, byte 221 bit 3 = 0 - "
                    "Rate selection using extended rate select requires byte 141, bits 1-0 != 0b00, byte 195 bit 5 = "
                    "1, byte 221 bit 2 = 0, byte 221 bit 3 = 1 - "
                    "Actual Settings: Byte 141 bits 1-0: {:#04b}, byte 195 bit 5 = {:d}, byte 221 bit 2 = {:d}, byte "
                    "221 bit 3 = {:d}",
                    ...
                    programming.byte_221_enhanced_options.reserved_bit_2,
                    programming.byte_221_enhanced_options
    ...
    void validateCC_EXTChecksum(const SFF8636_Upper00h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_223_CC_EXT != correctChecksum) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 223 (\"CC_EXT\") value is {:#04x}, but should be {:#04x}",
                    programming.byte_223_CC_EXT,
                    correctChecksum
                )
            );
        }
    ...
    // TODO: Introduce options to not warn on values in "Vendor Specific" ranges (in case this tool is used by actual
    // vendor?)
    common::ValidationResult validateSFF8636_Upper00h(
        const TransceiverTool::Standards::SFF8636::SFF8636_Upper00h& programming
    ) {
        common::ValidationResult validationResult;
