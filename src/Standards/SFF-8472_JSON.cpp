...
namespace TransceiverTool::Standards::SFF8472 {
    ...
    unsigned char charFromJSONByteStruct(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Tried to create byte from something that is not an object!");
        }

        const auto& byteValue = j.at("byteValue");
        if(!byteValue.is_string()) {
            throw std::invalid_argument("byteValue entry is not a string");
        }

        auto byteValueStr = byteValue.template get<std::string>();
        if(byteValueStr.length() != 4) {
            throw std::invalid_argument("byteValue has wrong length (must be 4)");
        }

        if(byteValueStr[0] != '0' || byteValueStr[1] != 'x') {
            throw std::invalid_argument("byteValue does not start with 0x");
        }

        if(!std::isxdigit(byteValueStr[2]) || !std::isxdigit(byteValueStr[3])) {
            throw std::invalid_argument("byteValue has invalid characters");
        }

        char* outPtr;
        unsigned long longValue = strtoul(byteValueStr.c_str(), &outPtr, 16);
        if(outPtr != byteValueStr.c_str() + 4) {
            throw std::invalid_argument("byteValue is not valid hex number??");
        }
        if(longValue > std::numeric_limits<unsigned char>::max()) {
            throw std::invalid_argument("byteValue exceeds byte range?!");
        }
    ...
    nlohmann::ordered_json PhysicalDeviceIdentifierToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8472::PhysicalDeviceIdentifierAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char PhysicalDeviceIdentifierFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            auto it = std::find_if(
                SFF8472::PhysicalDeviceIdentifierAssignedValues.begin(),
                SFF8472::PhysicalDeviceIdentifierAssignedValues.end(),
                [&strValue](const SFF8472::PhysicalDeviceIdentifierAssignedValue& entry) {
                    return entry.name == strValue;
                }
            );

            if(it == SFF8472::PhysicalDeviceIdentifierAssignedValues.end()) {
                throw std::invalid_argument("Identifier is not a known string value");
            }
    ...
    nlohmann::ordered_json PhysicalDeviceExtendedIdentifierToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8472::PhysicalDeviceExtendedIdentifierAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char PhysicalDeviceExtendedIdentifierFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            auto it = std::find_if(
                SFF8472::PhysicalDeviceExtendedIdentifierAssignedValues.begin(),
                SFF8472::PhysicalDeviceExtendedIdentifierAssignedValues.end(),
                [&strValue](const SFF8472::PhysicalDeviceExtendedIdentifierAssignedValue& entry) {
                    return entry.name == strValue;
                }
            );

            if(it == SFF8472::PhysicalDeviceExtendedIdentifierAssignedValues.end()) {
                throw std::invalid_argument("Extended Identifier is not a known string value");
            }
    ...
    nlohmann::ordered_json TransceiverConnectorTypeToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8024::TransceiverConnectorTypeAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char TransceiverConnectorTypeFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            auto it = std::find_if(
                SFF8024::TransceiverConnectorTypeAssignedValues.begin(),
                SFF8024::TransceiverConnectorTypeAssignedValues.end(),
                [&strValue](const SFF8024::TransceiverConnectorTypeAssignedValue& entry) {
                    return entry.name == strValue;
                }
            );

            if(it == SFF8024::TransceiverConnectorTypeAssignedValues.end()) {
                throw std::invalid_argument("Connector Type is not a known string value");
            }
    ...
    _10G_Ethernet_Compliance_Codes _10G_Ethernet_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("10G Ethernet Compliance Codes must be an object");
        }
    ...
    Infiniband_Compliance_Codes Infiniband_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Infiniband Compliance Codes must be an object");
        }
    ...
    ESCON_Compliance_Codes ESCON_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("ESCON Compliance Codes must be an object");
        }

        ESCON_Compliance_Codes complianceCodes;

        complianceCodes.ESCON_MMF_1310nm_LED_bit_7 =
            j.at("ESCON MMF, 1310nm LED compliant (Bit 7)").template get<bool>();
        complianceCodes.ESCON_SMF_1310nm_Laser_bit_6 =
            j.at("ESCON SMF, 1310nm Laser compliant (Bit 6)").template get<bool>();
    ...
    nlohmann::ordered_json SONET_Compliance_CodesToJSON(const SONET_Compliance_Codes& value) {
        ...
        j["SONET reach specifier (Byte 4, Bit 4-3)"] =
            getSFF8472_SONETReachSpecifierInfo(value.SONET_Reach_Specifier_byte_4_bit_4_3).name;
        ...
        j["OC-12, single mode, long reach compliant (Byte 5, Bit 6)"] =
            value.OC_12_single_mode_long_reach_2_byte_5_bit_6;
        j["OC-12, single mode, intermediate reach compliant (Byte 5, Bit 5)"] =
            value.OC_12_single_mode_intermediate_reach_byte_5_bit_5;
        ...
        j["OC-3, single mode, intermediate reach compliant (Byte 5, Bit 1)"] =
            value.OC_3_single_mode_intermediate_reach_byte_5_bit_1;
    ...
    SONET_Compliance_Codes SONET_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("SONET Compliance Codes must be an object");
        }

        SONET_Compliance_Codes complianceCodes;

        complianceCodes.OC_192_short_reach_byte_4_bit_5 =
            j.at("OC-192, short reach compliant (Byte 4, Bit 5)").template get<bool>();
        ...
        auto it = std::find_if(
            ...
            [&reachSpecifierStr](const SONETReachSpecifierAssignedValue& entry) {
                return entry.name == reachSpecifierStr;
            }
        );

        if(it == SONETReachSpecifierAssignedValues.end()) {
            throw std::invalid_argument("SONET reach specifier is not a known string value");
        }

        complianceCodes.SONET_Reach_Specifier_byte_4_bit_4_3 = it->enum_value;

        complianceCodes.OC_48_long_reach_byte_4_bit_2 =
            j.at("OC-48, long reach compliant (Byte 4, Bit 2)").template get<bool>();
        complianceCodes.OC_48_intermediate_reach_byte_4_bit_1 =
            j.at("OC-48, intermediate reach compliant (Byte 4, Bit 1)").template get<bool>();
        complianceCodes.OC_48_short_reach_byte_4_bit_0 =
            j.at("OC-48, short reach compliant (Byte 4, Bit 0)").template get<bool>();
        complianceCodes.reserved_byte_5_bit_7 = j.at("Reserved (Byte 5, Bit 7)").template get<bool>();
        complianceCodes.OC_12_single_mode_long_reach_2_byte_5_bit_6 =
            j.at("OC-12, single mode, long reach compliant (Byte 5, Bit 6)").template get<bool>();
        complianceCodes.OC_12_single_mode_intermediate_reach_byte_5_bit_5 =
            j.at("OC-12, single mode, intermediate reach compliant (Byte 5, Bit 5)").template get<bool>();
        complianceCodes.OC_12_short_reach_byte_5_bit_4 =
            j.at("OC-12, short reach compliant (Byte 5, Bit 4)").template get<bool>();
        complianceCodes.reserved_byte_5_bit_3 = j.at("Reserved (Byte 5, Bit 3)").template get<bool>();
        complianceCodes.OC_3_single_mode_long_reach_byte_5_bit_2 =
            j.at("OC-3, single mode, long reach compliant (Byte 5, Bit 2)").template get<bool>();
        complianceCodes.OC_3_single_mode_intermediate_reach_byte_5_bit_1 =
            j.at("OC-3, single mode, intermediate reach compliant (Byte 5, Bit 1)").template get<bool>();
        complianceCodes.OC_3_short_reach__byte_5_bit_0 =
            j.at("OC-3, short reach compliant (Byte 5, Bit 0)").template get<bool>();
    ...
    Ethernet_Compliance_Codes Ethernet_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Ethernet Compliance Codes must be an object");
        }
    ...
    Fibre_Channel_Link_Length_Codes Fibre_Channel_Link_Length_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Fibre Channel Link Length must be an object");
        }

        Fibre_Channel_Link_Length_Codes complianceCodes;

        complianceCodes.very_long_distance_v_bit_7 =
            j.at("very long distance (V) compliant (Bit 7)").template get<bool>();
        complianceCodes.short_distance_s_bit_6 = j.at("short distance (S) compliant (Bit 6)").template get<bool>();
        complianceCodes.intermediate_distance_i_bit_5 =
            j.at("intermediate distance (I) compliant (Bit 5)").template get<bool>();
    ...
    nlohmann::ordered_json Fibre_Channel_Technology_CodesToJSON(const Fibre_Channel_Technology_Codes& value) {
        ...
        j["Shortwave laser, linear Rx (SA) compliant (Byte 7, Bit 2)"] =
            value.Shortwave_laser_linear_Rx_SA_byte_7_bit_2;
        j["Longwave laser (LC) compliant (Byte 7, Bit 1)"] = value.Longwave_laser_LC_byte_7_bit_1;
        j["Electrical inter-enclosure (EL) compliant (Byte 7, Bit 0)"] =
            value.Electrical_inter_enclosure_EL_byte_7_bit_0;
        j["Electrical intra-enclosure (EL) compliant (Byte 8, Bit 7)"] =
            value.Electrical_intra_enclosure_EL_byte_byte_8_bit_7;
    ...
    Fibre_Channel_Technology_Codes Fibre_Channel_Technology_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Fibre Channel Technology must be an object");
        }

        Fibre_Channel_Technology_Codes complianceCodes;

        complianceCodes.Shortwave_laser_linear_Rx_SA_byte_7_bit_2 =
            j.at("Shortwave laser, linear Rx (SA) compliant (Byte 7, Bit 2)").template get<bool>();
        complianceCodes.Longwave_laser_LC_byte_7_bit_1 =
            j.at("Longwave laser (LC) compliant (Byte 7, Bit 1)").template get<bool>();
        complianceCodes.Electrical_inter_enclosure_EL_byte_7_bit_0 =
            j.at("Electrical inter-enclosure (EL) compliant (Byte 7, Bit 0)").template get<bool>();
        complianceCodes.Electrical_intra_enclosure_EL_byte_byte_8_bit_7 =
            j.at("Electrical intra-enclosure (EL) compliant (Byte 8, Bit 7)").template get<bool>();
        complianceCodes.Shortwave_laser_w_o_OFC_SN_byte_8_bit_6 =
            j.at("Shortwave laser w/o OFC (SN) compliant (Byte 8, Bit 6)").template get<bool>();
        complianceCodes.Shortwave_laser_with_OFC_SL_byte_8_bit_5 =
            j.at("Shortwave laser with OFC (SL) compliant (Byte 8, Bit 5)").template get<bool>();
        complianceCodes.Longwave_Laser_LL_byte_8_bit_4 =
            j.at("Longwave laser (LL) compliant (Byte 8, Bit 4)").template get<bool>();
    ...
    SFP_plus_Cable_Technology_Codes SFP_plus_Cable_Technology_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("SFP+ Cable Technology must be an object");
        }
    ...
    // ############
    nlohmann::ordered_json Fibre_Channel_Transmission_Media_CodesToJSON(
        const Fibre_Channel_Transmission_Media_Codes& value
    ) {
        nlohmann::ordered_json j;
    ...
    Fibre_Channel_Transmission_Media_Codes Fibre_Channel_Transmission_Media_CodesFromJSON(const nlohmann::json& j) {
        ...
        complianceCodes.Multimode_62_5_um_M6_bit_3 =
            j.at("Multimode, 62.5um (M6) compliant (Bit 3)").template get<bool>();
        complianceCodes.Multimode_50_um_M5_M5E_bit_2 =
            j.at("Multimode, 50um (M5, M5E) compliant (Bit 2)").template get<bool>();
        complianceCodes.reserved_bit_1 = j.at("Reserved (Bit 1)").template get<bool>();
    ...
    Fibre_Channel_Speed_Codes Fibre_Channel_Speed_CodesFromJSON(const nlohmann::json& j) {
        ...
        complianceCodes.see_byte_62_fibre_channel_speed_2_bit_1 =
            j.at("See byte 62 \"Fibre Channel Speed 2\" (Bit 1)").template get<bool>();
    ...
    nlohmann::ordered_json EncodingToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8024::SFF8472TransceiverEncodingAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char EncodingFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            auto it = std::find_if(
                SFF8024::SFF8472TransceiverEncodingAssignedValues.begin(),
                SFF8024::SFF8472TransceiverEncodingAssignedValues.end(),
                [&strValue](const SFF8024::SFF8472TransceiverEncodingAssignedValue& entry) {
                    return entry.name == strValue;
                }
            );

            if(it == SFF8024::SFF8472TransceiverEncodingAssignedValues.end()) {
                throw std::invalid_argument("Encoding is not a known string value");
            }
    ...
    unsigned char NominalSignalingRate100MBaudFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            throw std::invalid_argument(
                "Nominal Signaling Rate can only have value Not Specified or > 25.4 GBd if string"
            );
        } else if(j.is_number_unsigned()) {
            auto numberValue = j.template get<std::uint64_t>();

            if(numberValue % 100 != 0) {
                throw std::invalid_argument("Nominal Signaling Rate must be divisble by 100!");
            }

            if(numberValue > 25400) {
                throw std::invalid_argument("Nominal Signaling Rate must not be larger than 25400");
            }
    ...
    unsigned char RateIdentifierFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            if(it == SFF8472::RateIdentifierAssignedValues.end()) {
                throw std::invalid_argument("Rate Identifier is not a known string value");
            }
    ...
    nlohmann::ordered_json LinkLengthInfoToJSON(
        ...
        if(fiberMode) {
            ...
            if(byte_14_length_smf_in_kilometers_or_copper_attenuation_in_db_at_12_9_ghz == 0xFF) {
                ...
                j["Length (SMF) [km]"] =
                    (unsigned long)(byte_14_length_smf_in_kilometers_or_copper_attenuation_in_db_at_12_9_ghz);
            }
            ...
            if(byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz == 0xFF) {
                ...
                j["Length (SMF) [m] (Divisible by 100)"] =
                    (unsigned long)(byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz) * 100ul;
            }
            ...
            if(byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m == 0xFF) {
                ...
                j["Length (OM4 50 um) [m] (Divisible by 10)"] =
                    (unsigned long)(byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m) * 10ul;
            }
            ...
            if(byte_19_length_om3_in_10m_or_copper_or_dac_multiplier_and_base_value == 0xFF) {
                ...
                j["Length (OM3 50 um) [m] (Divisible by 10)"] =
                    (unsigned long)(byte_19_length_om3_in_10m_or_copper_or_dac_multiplier_and_base_value) * 10ul;
            }
        } else {
            ...
            if(byte_14_length_smf_in_kilometers_or_copper_attenuation_in_db_at_12_9_ghz == 0) {
                ...
                j["Copper Cable Attenuation @ 12.9 GHz [dB]"] =
                    (unsigned long)(byte_14_length_smf_in_kilometers_or_copper_attenuation_in_db_at_12_9_ghz);
            }
            ...
            if(byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz == 0) {
                ...
                j["Copper Cable Attenuation @ 25.78 GHz [dB]"] =
                    (unsigned long)(byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz);
            }
            ...
            if(byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m == 0xFF) {
                ...
                j["Length (Copper) or Actual Length (DAC) [m]"] =
                    (unsigned long)(byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m);
            }

            unsigned char multiplierBits =
                (byte_19_length_om3_in_10m_or_copper_or_dac_multiplier_and_base_value & 0b11000000) >> 6;

            if(multiplierBits == 0) {
                j["Length (Copper) or Actual Length (DAC), Additional, Multiplier"] = "0.1";
            } else if(multiplierBits == 1) {
                j["Length (Copper) or Actual Length (DAC), Additional, Multiplier"] = "1";
            } else if(multiplierBits == 2) {
                j["Length (Copper) or Actual Length (DAC), Additional, Multiplier"] = "10";
            } else {
                j["Length (Copper) or Actual Length (DAC), Additional, Multiplier"] = "100";
            }
    ...
    LinkLengthInfoFromJSONReturn LinkLengthInfoFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Link Length must be an object");
        }
        ...
        if(typeStr == "Copper or Direct Attach") {
            ...
            if(copper_cable_attenuation_12ghz_val.is_string()) {
                if(copper_cable_attenuation_12ghz_val.template get<std::string>() != "N/A") {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 12.9 GHz [dB] has string value, must be N/A"
                    );
                }
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 12.9 GHz [dB] must not be greater than 255"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Copper Cable Attenuation @ 12.9 GHz [dB] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(copper_cable_attenuation_25ghz_val.is_string()) {
                if(copper_cable_attenuation_25ghz_val.template get<std::string>() != "N/A") {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 25.78GHz [dB] has string value, must be N/A"
                    );
                }
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 25.78GHz [dB] must not be greater than 255"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Copper Cable Attenuation @ 25.78GHz [dB] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_om2_val.is_string()) {
                if(length_om2_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (OM2 50 um) [m] (Divisible by 10) has string value, must be N/A or > 2.54 km"
                    );
                }
                ...
                if(numberValue % 10 != 0) {
                    throw std::invalid_argument("Length (OM2 50 um) [m] (Divisible by 10) must be divisible by 10");
                }
                if(numberValue > 2540) {
                    throw std::invalid_argument(
                        "Length (OM2 50 um) [m] (Divisible by 10) must not be greater than 2540"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Length (OM2 50 um) [m] (Divisible by 10) has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_om1_val.is_string()) {
                if(length_om1_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (OM1 62.5 um) [m] (Divisible by 10) has string value, must be N/A or > 2.54 km"
                    );
                }
                ...
                if(numberValue % 10 != 0) {
                    throw std::invalid_argument("Length (OM1 62.5 um) [m] (Divisible by 10) must be divisible by 10");
                }
                if(numberValue > 2540) {
                    throw std::invalid_argument(
                        "Length (OM1 62.5 um) [m] (Divisible by 10) must not be greater than 2540"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Length (OM1 62.5 um) [m] (Divisible by 10) has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_copper_val.is_string()) {
                if(length_copper_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (Copper) or Actual Length (DAC) [m] has string value, must be N/A or > 254 m"
                    );
                }
                ...
                if(numberValue > 254) {
                    throw std::invalid_argument(
                        "Length (Copper) or Actual Length (DAC) [m] must not be greater than 254"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Length (Copper) or Actual Length (DAC) [m] has wrong type (neither string nor unsigned integer)"
                );
            }

            const auto& length_additional_multiplier_val =
                j.at("Length (Copper) or Actual Length (DAC), Additional, Multiplier");
            if(!length_additional_multiplier_val.is_string()) {
                throw std::invalid_argument(
                    "Length (Copper) or Actual Length (DAC), Additional, Multiplier must be a string!"
                );
            }

            unsigned char multiplierBits;
            if(length_additional_multiplier_val.template get<std::string>() == "0.1") {
                multiplierBits = 0b00;
            } else if(length_additional_multiplier_val.template get<std::string>() == "1") {
                multiplierBits = 0b01;
            } else if(length_additional_multiplier_val.template get<std::string>() == "10") {
                multiplierBits = 0b10;
            } else if(length_additional_multiplier_val.template get<std::string>() == "100") {
                multiplierBits = 0b11;
            } else {
                throw std::invalid_argument(
                    "Length (Copper) or Actual Length (DAC), Additional, Multiplier must be either 0.1, 1, 10 or 100"
                );
            }

            const auto& length_additional_base_val =
                j.at("Length (Copper) or Actual Length (DAC), Additional, Base Value [m]");
            if(!length_additional_base_val.is_number_unsigned()) {
                throw std::invalid_argument(
                    "Length (Copper) or Actual Length (DAC), Additional, Base Value [m] must be an unsigned integer!"
                );
            }

            auto length_additional_base_number_value = length_additional_base_val.template get<std::uint64_t>();
            if(length_additional_base_number_value > 63) {
                throw std::invalid_argument(
                    "Length (Copper) or Actual Length (DAC), Additional, Base Value [m] must not be greater than 63"
                );
            }

            parsedStruct.byte_19_length_om3_in_10m_or_copper_or_dac_multiplier_and_base_value =
                (multiplierBits << 6) | (unsigned char)(length_additional_base_number_value);
            ...
            if(length_smf_km_val.is_string()) {
                ...
                if(numberValue > 254) {
                    throw std::invalid_argument("Length (SMF) [km] must not be greater than 254");
                }
            ...
            if(length_smf_m_val.is_string()) {
                if(length_smf_m_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (SMF) [m] (Divisible by 100) has string value, must be N/A or > 25.4 km"
                    );
                }
                ...
                if(numberValue % 100 != 0) {
                    throw std::invalid_argument("Length (SMF) [m] (Divisible by 100) must be divisible by 10");
                }
                if(numberValue > 25400) {
                    throw std::invalid_argument("Length (SMF) [m] (Divisible by 100) must not be greater than 25400");
                }

                parsedStruct.byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz = numberValue / 100;
            } else {
                throw std::invalid_argument(
                    "Length (SMF) [m] (Divisible by 100) has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_om4_val.is_string()) {
                if(length_om4_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (OM4 50 um) [m] (Divisible by 10) has string value, must be N/A or > 2.54 km"
                    );
                }
                ...
                if(numberValue % 10 != 0) {
                    throw std::invalid_argument("Length (OM4 50 um) [m] (Divisible by 10) must be divisible by 10");
                }
                if(numberValue > 2540) {
                    throw std::invalid_argument(
                        "Length (OM4 50 um) [m] (Divisible by 10) must not be greater than 2540"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Length (OM4 50 um) [m] (Divisible by 10) has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_om3_val.is_string()) {
                if(length_om3_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (OM3 50 um) [m] (Divisible by 10) has string value, must be N/A or > 2.54 km"
                    );
                }
                ...
                if(numberValue % 10 != 0) {
                    throw std::invalid_argument("Length (OM3 50 um) [m] (Divisible by 10) must be divisible by 10");
                }
                if(numberValue > 2540) {
                    throw std::invalid_argument(
                        "Length (OM3 50 um) [m] (Divisible by 10) must not be greater than 2540"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Length (OM3 50 um) [m] (Divisible by 10) has wrong type (neither string nor unsigned integer)"
                );
            }
        } else {
            throw std::invalid_argument(
                "Link Length has invalid Type string, must be 'Copper or Direct Attach' or Fibre"
            );
        }
    ...
    nlohmann::ordered_json VendorNameToJSON(const std::array<unsigned char, 16>& vendorNameRaw) {
        bool vendorNamePrintable =
            std::all_of(vendorNameRaw.begin(), vendorNameRaw.end(), [](char c) { return std::isprint(c); });
        ...
        if(vendorNamePrintable) {
            std::string vendorName =
                std::string(reinterpret_cast<char const*>(vendorNameRaw.data()), vendorNameRaw.size());
            // rtrim
            vendorName.erase(
                std::find_if(
                    vendorName.rbegin(), vendorName.rend(), [](unsigned char ch) { return !(ch == 0x20); }
                ).base(),
                vendorName.end()
            );
    ...
    std::array<unsigned char, 16> VendorNameFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            // We don't care whether it contains unprintable characters - when we serialise and check, it's only to
            // prevent invalid JSON being generated However, as this is a parsed value, we know that the JSON must be
            // valid. Let the user enter what they want...
            if(strVal.size() > 16) {
                throw std::invalid_argument("Vendor Name must not have more than 16 characters");
            }

            if(strVal.size() < 16) {
                strVal.resize(16, 0x20);
            }

            std::memcpy(arr.data(), strVal.data(), strVal.size());
        } else if(j.is_object()) {
            if(j.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Vendor Name object must have Type Base64");
            }
            ...
            if(decoded.size() != 16) {
                throw std::invalid_argument("Vendor Name specified as base64 must have exactly 16 characters!");
            }
    ...
    nlohmann::ordered_json ExtendedComplianceCodesToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8024::ExtendedComplianceCodesAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char ExtendedComplianceCodesFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            auto it = std::find_if(
                SFF8024::ExtendedComplianceCodesAssignedValues.begin(),
                SFF8024::ExtendedComplianceCodesAssignedValues.end(),
                [&strValue](const SFF8024::ExtendedComplianceCodesAssignedValue& entry) {
                    return entry.name == strValue;
                }
            );

            if(it == SFF8024::ExtendedComplianceCodesAssignedValues.end()) {
                throw std::invalid_argument("Extended Specification Compliance Codes is not a known string value");
            }
            ...
            throw std::invalid_argument(
                " Extended Specification Compliance Codes has wrong type (neither string nor object)"
            );
        }
    }
    ...
    std::array<unsigned char, 3> VendorOUIFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            if(strVal.size() != 8) {
                throw std::invalid_argument("Vendor OUI string must be exactly 8 characters long");
            }
            ...
            if(VendorOUIsIt == TransceiverTool::VendorOUIs.end()) {
                throw std::invalid_argument("Vendor OUI Vendor Name not known");
            }
    ...
    nlohmann::ordered_json VendorPNToJSON(const std::array<unsigned char, 16>& vendorPNRaw) {
        bool vendorPNPrintable =
            std::all_of(vendorPNRaw.begin(), vendorPNRaw.end(), [](char c) { return std::isprint(c); });
        ...
        if(vendorPNPrintable) {
            ...
            // rtrim
            vendorPN.erase(
                std::find_if(vendorPN.rbegin(), vendorPN.rend(), [](unsigned char ch) { return !(ch == 0x20); }).base(),
                vendorPN.end()
            );
    ...
    std::array<unsigned char, 16> VendorPNFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            // valid. Let the user enter what they want...
            if(strVal.size() > 16) {
                throw std::invalid_argument("Vendor Part Number must not have more than 16 characters");
            }
            ...
            if(j.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Vendor Part Number object must have Type Base64");
            }
            ...
            if(decoded.size() != 16) {
                throw std::invalid_argument("Vendor Part Number specified as base64 must have exactly 16 characters!");
            }
    ...
    nlohmann::ordered_json VendorRevToJSON(const std::array<unsigned char, 4>& vendorRevRaw) {
        bool vendorRevPrintable =
            std::all_of(vendorRevRaw.begin(), vendorRevRaw.end(), [](char c) { return std::isprint(c); });

        nlohmann::ordered_json j;


        if(vendorRevPrintable) {
            std::string vendorRev =
                std::string(reinterpret_cast<char const*>(vendorRevRaw.data()), vendorRevRaw.size());
            // rtrim
            vendorRev.erase(
                std::find_if(
                    vendorRev.rbegin(), vendorRev.rend(), [](unsigned char ch) { return !(ch == 0x20); }
                ).base(),
                vendorRev.end()
            );
    ...
    std::array<unsigned char, 4> VendorRevFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            // valid. Let the user enter what they want...
            if(strVal.size() > 4) {
                throw std::invalid_argument("Vendor Rev must not have more than 4 characters");
            }

            if(strVal.size() < 4) {
                strVal.resize(4, 0x20);
            }

            std::memcpy(arr.data(), strVal.data(), strVal.size());
        } else if(j.is_object()) {
            if(j.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Vendor Rev object must have Type Base64");
            }
            ...
            if(decoded.size() != 4) {
                throw std::invalid_argument("Vendor Rev specified as base64 must have exactly 2 characters!");
            }
    ...
    nlohmann::ordered_json WavelengthOrCableSpecificationComplianceToJSON(
        ...
        if(false && !byte_8_sfp_plus_cable_technology_codes_Passive_Cable_bit_2 &&
           !byte_8_sfp_plus_cable_technology_codes_Active_Cable_bit_3) {
            ...
            byte_8_sfp_plus_cable_technology_codes_Passive_Cable_bit_2 &&
            !byte_8_sfp_plus_cable_technology_codes_Active_Cable_bit_3
        ) {
            // Passive cable
            j["Type"] = "Passive Cable";

            j["Reserved (Byte 60, Bit 7)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 7));
            j["Reserved (Byte 60, Bit 6)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 6));
            j["Reserved for SFF-8461 (Byte 60, Bit 5)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 5));
            j["Reserved for SFF-8461 (Byte 60, Bit 4)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 4));
            j["Reserved for SFF-8461 (Byte 60, Bit 3)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 3));
            j["Reserved for SFF-8461 (Byte 60, Bit 2)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 2));
            j["FC-PI-4 Appendix H compliant (Byte 60, Bit 1)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 1));
            j["SFF-8431 Appendix E compliant (Byte 60, Bit 0)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 0));

            j["Reserved (Byte 61, Bit 7)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 7));
            j["Reserved (Byte 61, Bit 6)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 6));
            j["Reserved (Byte 61, Bit 5)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 5));
            j["Reserved (Byte 61, Bit 4)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 4));
            j["Reserved (Byte 61, Bit 3)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 3));
            j["Reserved (Byte 61, Bit 2)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 2));
            j["Reserved (Byte 61, Bit 1)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 1));
            j["Reserved (Byte 61, Bit 0)"] =
                bool(byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 0));
        } else {
            ...
            j["Reserved (Byte 60, Bit 6)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 6));
            j["Reserved (Byte 60, Bit 5)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 5));
            j["Reserved (Byte 60, Bit 4)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 4));
            j["FC-PI-4 Limiting compliant (Byte 60, Bit 3)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 3));
            j["SFF-8431 Limiting compliant (Byte 60, Bit 2)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 2));
            j["FC-PI-4 Appendix H compliant (Byte 60, Bit 1)"] =
                bool(byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 1));
            j["SFF-8431 Appendix E compliant (Byte 60, Bit 0)"] =
    ...
    WavelengthOrCableSpecificationComplianceJSONReturn WavelengthOrCableSpecificationComplianceFromJSON(
        const nlohmann::json& j
    ) {

        if(!j.is_object()) {
            throw std::invalid_argument("Wavelength Or Cable Specification Compliance must be an object");
        }
        ...
        if(typeStr == "Wavelength") {
            ...
            if(!wavelengthVal.is_number_unsigned()) {
                throw std::invalid_argument("Wavelength [nm] must be an unsigned number");
            }

            auto wavelengthRaw = wavelengthVal.template get<std::uint64_t>();
            if(wavelengthRaw > 65535) {
                throw std::invalid_argument("Wavelength must not be greater than 65535!");
            }

            parsedStruct.byte_60_wavelength_high_order_byte_or_cable_specification_compliance =
                (wavelengthRaw >> 8) & (0b11111111);
            parsedStruct.byte_61_wavelength_low_order_byte_or_cable_specification_compliance =
                (wavelengthRaw >> 0) & (0b11111111);
            ...
            throw std::invalid_argument(
                "Wavelength Or Cable Specification Compliance has invalid Type string, must be Wavelength, Passive "
                "Cable or Active Cable"
            );
        }
    ...
    std::optional<unsigned char> CC_BASEChecksumFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            auto strValue = j.template get<std::string>();
            if(strValue != "auto") {
                throw std::invalid_argument("CC_BASE string value must be auto");
            }
    ...
    // ############
    nlohmann::ordered_json OptionValuesToJSON(
        const Option_Values_Byte_64& byte_64_option_values,
        const Option_Values_Byte_65& byte_65_option_values
    ) {
        nlohmann::ordered_json j;

        j["Reserved (Byte 64, Bit 7)"] = byte_64_option_values.reserved_bit_7;
        j["High Power Level (Level 4) requirement (Byte 64, Bit 6)"] =
            byte_64_option_values.high_level_power_level_4_bit_6;
        j["High Power Level (Level 3 or Level 4) requirement (Byte 64, Bit 5)"] =
            byte_64_option_values.high_level_power_level_4_3_bit_5;
        j["Paging implemented (Byte 64, Bit 4)"] = byte_64_option_values.paging_implemented_indicator_bit_4;
        j["Internal retimer or data recovery (CDR) circuit present (Byte 64, Bit 3)"] =
            byte_64_option_values.retimer_or_cdr_indicator_bit_3;
        ...
        j["Linear Receiver Output implemented (Byte 64, Bit 0)"] =
            byte_64_option_values.linear_receiver_output_implemented_bit_0;

        j["Receiver decision threshold implemented (Byte 65, Bit 7)"] =
            byte_65_option_values.receiver_rdt_implemented_bit_7;
        j["Transmitter tunable (Byte 65, Bit 6)"] = byte_65_option_values.receiver_tunable_bit_6;
        j["RATE_SELECT functionality implemented (Byte 65, Bit 5)"] =
            byte_65_option_values.rate_select_implemented_bit_5;
        ...
        j["Loss of Signal with inverted signal implemented (Byte 65, Bit 2)"] =
            byte_65_option_values.loss_of_signal_inverted_bit_2;
    ...
    std::tuple<Option_Values_Byte_64, Option_Values_Byte_65> OptionValuesFromJSON(const nlohmann::json& j) {
        ...
        byte_64_option_values.high_level_power_level_4_bit_6 =
            j.at("High Power Level (Level 4) requirement (Byte 64, Bit 6)").template get<bool>();
        byte_64_option_values.high_level_power_level_4_3_bit_5 =
            j.at("High Power Level (Level 3 or Level 4) requirement (Byte 64, Bit 5)").template get<bool>();
        byte_64_option_values.paging_implemented_indicator_bit_4 =
            j.at("Paging implemented (Byte 64, Bit 4)").template get<bool>();
        byte_64_option_values.retimer_or_cdr_indicator_bit_3 =
            j.at("Internal retimer or data recovery (CDR) circuit present (Byte 64, Bit 3)").template get<bool>();
        byte_64_option_values.cooled_transceiver_bit_2 = j.at("Cooled Laser (Byte 64, Bit 2)").template get<bool>();
        byte_64_option_values.power_level_2_bit_1 =
            j.at("Power Level 2 requirement (Byte 64, Bit 1)").template get<bool>();
        byte_64_option_values.linear_receiver_output_implemented_bit_0 =
            j.at("Linear Receiver Output implemented (Byte 64, Bit 0)").template get<bool>();

        byte_65_option_values.receiver_rdt_implemented_bit_7 =
            j.at("Receiver decision threshold implemented (Byte 65, Bit 7)").template get<bool>();
        byte_65_option_values.receiver_tunable_bit_6 =
            j.at("Transmitter tunable (Byte 65, Bit 6)").template get<bool>();
        byte_65_option_values.rate_select_implemented_bit_5 =
            j.at("RATE_SELECT functionality implemented (Byte 65, Bit 5)").template get<bool>();
        byte_65_option_values.tx_disable_implemented_bit_4 =
            j.at("TX_DISABLE implemented (Byte 65, Bit 4)").template get<bool>();
        byte_65_option_values.tx_fault_implemented_bit_3 =
            j.at("TX_FAULT signal implemented (Byte 65, Bit 3)").template get<bool>();
        byte_65_option_values.loss_of_signal_inverted_bit_2 =
            j.at("Loss of Signal with inverted signal implemented (Byte 65, Bit 2)").template get<bool>();
        byte_65_option_values.loss_of_signal_implemented_bit_1 =
            j.at("Loss of Signal implemented (Byte 65, Bit 1)").template get<bool>();
    ...
    nlohmann::ordered_json ExtendedSignalingRateInfoToJSON(
        ...
        if(byte_12_nominal_signaling_rate_in_100_mbaud != 0xFF) {
            ...
            j["Upper signaling rate margin [%]"] =
                byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud;

            j["Lower signaling rate margin [%]"] =
                byte_67_min_signaling_rate_in_percent_or_range_of_signaling_rates_in_percent;
        } else {
            j["Type"] = "Extended";
            ...
            if(byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud == 0x00) {
                ...
                j["Extended Signaling Rate [MBaud] (Divisible by 250)"] =
                    (unsigned long)(byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud) *
                    250ul;
            }

            j["Signaling rate margin [%]"] =
                byte_67_min_signaling_rate_in_percent_or_range_of_signaling_rates_in_percent;
        }
    ...
    ExtendedSignalingRateInfoFromJSONReturn ExtendedSignalingRateFromJSON(const nlohmann::json& j) {
        ...
        if(!j.is_object()) {
            throw std::invalid_argument("Extended Signaling Rate must be an object");
        }
        ...
        if(typeStr == "Standard") {
            ...
            auto upperSignalingRateMarginPercentNumberValue =
                upperSignalingRateMarginPercentValue.template get<std::uint64_t>();

            if(upperSignalingRateMarginPercentNumberValue > 255) {
                throw std::invalid_argument("Upper signaling rate margin [%] must not be larger than 255");
            }

            parsedStruct.byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud =
                upperSignalingRateMarginPercentNumberValue;


            const auto& lowerSignalingRateMarginPercentValue = j.at("Lower signaling rate margin [%]");
            auto lowerSignalingRateMarginPercentNumberValue =
                lowerSignalingRateMarginPercentValue.template get<std::uint64_t>();

            if(lowerSignalingRateMarginPercentNumberValue > 255) {
                throw std::invalid_argument("Lower signaling rate margin [%] must not be larger than 255");
            }

            parsedStruct.byte_67_min_signaling_rate_in_percent_or_range_of_signaling_rates_in_percent =
                lowerSignalingRateMarginPercentNumberValue;
            ...
            if(extendedSignalingRateValue.is_string()) {
                ...
                if(strValue != "Unspecified") {
                    throw std::invalid_argument("Extended Signaling Rate can only have value Unspecified if string");
                }
                ...
                if(numberValue % 250 != 0) {
                    throw std::invalid_argument("Extended Signaling Rate must be divisble by 250");
                }

                if(numberValue > 63750) {
                    throw std::invalid_argument("Extended Signaling Rate must not be larger than 63750");
                }
                ...
                throw std::invalid_argument(
                    "Extended Signaling Rate has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(signalingRateMarginPercentNumberValue > 255) {
                throw std::invalid_argument("Signaling rate margin [%] must not be larger than 255");
            }

            parsedStruct.byte_67_min_signaling_rate_in_percent_or_range_of_signaling_rates_in_percent =
                signalingRateMarginPercentNumberValue;

        } else {
            throw std::invalid_argument(
                "Extended Signaling Rate has invalid Type string, must be Standard or Extended"
            );
        }
    ...
    nlohmann::ordered_json VendorSNToJSON(const std::array<unsigned char, 16>& vendorSNRaw) {
        bool vendorSNPrintable =
            std::all_of(vendorSNRaw.begin(), vendorSNRaw.end(), [](char c) { return std::isprint(c); });
        ...
        if(vendorSNPrintable) {
            ...
            // rtrim
            vendorSN.erase(
                std::find_if(vendorSN.rbegin(), vendorSN.rend(), [](unsigned char ch) { return !(ch == 0x20); }).base(),
                vendorSN.end()
            );
    ...
    std::array<unsigned char, 16> VendorSNFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            // valid. Let the user enter what they want...
            if(strVal.size() > 16) {
                throw std::invalid_argument("Vendor Serial Number must not have more than 16 characters");
            }
            ...
            if(j.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Vendor Serial Number object must have Type Base64");
            }
            ...
            if(decoded.size() != 16) {
                throw std::invalid_argument(
                    "Vendor Serial Number specified as base64 must have exactly 16 characters!"
                );
            }
    ...
    nlohmann::ordered_json DateCodeToJSON(const DateCode& dateCode) {
        ...
        bool dateCodeYearIsNumber =
            std::isdigit(dateCode.year_low_order_digits[0]) && std::isdigit(dateCode.year_low_order_digits[1]);

        if(dateCodeYearIsNumber) {
            int digits_of_year = std::stoi(
                std::string(
                    reinterpret_cast<char const*>(dateCode.year_low_order_digits.data()),
                    dateCode.year_low_order_digits.size()
                )
            );
            ...
            j["Year low order digits (Byte 84-85)"]["Value"] = cppcodec::base64_rfc4648::encode(
                dateCode.year_low_order_digits.data(), dateCode.year_low_order_digits.size()
            );
        }
        ...
        if(dateCodeMonthIsNumber) {
            int digits_of_month = std::stoi(
                std::string(reinterpret_cast<char const*>(dateCode.month_digits.data()), dateCode.month_digits.size())
            );

            if(digits_of_month < 1 || digits_of_month > 12) {
                j["Month digits (Byte 86-87)"]["Type"] = "Base64";
                j["Month digits (Byte 86-87)"]["Value"] =
                    cppcodec::base64_rfc4648::encode(dateCode.month_digits.data(), dateCode.month_digits.size());
            } else {
        ...
        if(dateCodeDayIsNumber) {
            int day = std::stoi(
                std::string(reinterpret_cast<char const*>(dateCode.day_digits.data()), dateCode.day_digits.size())
            );

            if(day < 1 || day > 31) {
                j["Day (Byte 88-89)"]["Type"] = "Base64";
                j["Day (Byte 88-89)"]["Value"] =
                    cppcodec::base64_rfc4648::encode(dateCode.day_digits.data(), dateCode.day_digits.size());
            } else {
        ...
        if(vendorLotCodePrintable) {
            ...
            std::string vendorLotCode =
                std::string(reinterpret_cast<char const*>(dateCode.lot_code.data()), dateCode.lot_code.size());
            vendorLotCode.erase(
                std::find_if(
                    vendorLotCode.rbegin(), vendorLotCode.rend(), [](unsigned char ch) { return !(ch == 0x20); }
                ).base(),
                vendorLotCode.end()
            );
            ...
            j["Vendor Lot Code (Byte 90-91)"]["Value"] =
                cppcodec::base64_rfc4648::encode(dateCode.lot_code.data(), dateCode.lot_code.size());
        }
    ...
    DateCode DateCodeFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Date Code must be an object");
        }
        ...
        if(dateCodeYearVal.is_number_unsigned()) {
            ...
            if(dateCodeNumVal > 99) {
                throw std::invalid_argument("Year low order digits (Byte 84-85) must not be greater than 99");
            }
            ...
            if(dateCodeYearVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Year low order digits (Byte 84-85) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument(
                    "Year low order digits (Byte 84-85) specified as base64 must have exactly 2 characters!"
                );
            }
        ...
        if(dateCodeMonthVal.is_number_unsigned()) {
            ...
            if(dateCodeNumVal > 99) {
                throw std::invalid_argument("Month digits (Byte 86-87) must not be greater than 99");
            }
            ...
            if(dateCodeMonthVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Month digits (Byte 86-87) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument(
                    "Month digits (Byte 86-87) specified as base64 must have exactly 2 characters!"
                );
            }
        ...
        if(dateCodeDayVal.is_number_unsigned()) {
            ...
            if(dateCodeNumVal > 99) {
                throw std::invalid_argument("Day (Byte 88-89) must not be greater than 99");
            }
            ...
            if(dateCodeDayVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Day (Byte 88-89) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument("Day (Byte 88-89) specified as base64 must have exactly 2 characters!");
            }
        ...
        if(dateCodeLotVal.is_string()) {
            ...
            if(dateCodeStrVal.size() > 2) {
                throw std::invalid_argument("Vendor Lot Code (Byte 90-91) string must not be longer than 2 characters");
            }
            if(dateCodeStrVal.size() < 2) {
                dateCodeStrVal.resize(2, 0x20);
            }
            ...
            if(dateCodeLotVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Vendor Lot Code (Byte 90-91) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument(
                    "Vendor Lot Code (Byte 90-91) specified as base64 must have exactly 2 characters!"
                );
            }
    ...
    nlohmann::ordered_json Diagnostic_Monitoring_TypeToJSON(const Diagnostic_Monitoring_Type& value) {
        ...
        j["Received power measurement type (Bit 3)"] =
            value.received_power_measurement_is_average_bit_3 ? "Average" : "OMA";
    ...
    Diagnostic_Monitoring_Type Diagnostic_Monitoring_TypeFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Diagnostic Monitoring Type must be an object");
        }

        Diagnostic_Monitoring_Type value;

        value.reserved_bit_7 = j.at("Reserved (Bit 7)").template get<bool>();
        value.digital_diagnostic_monitoring_implemented_bit_6 =
            j.at("Digital diagnostic monitoring implemented (Bit 6)").template get<bool>();
        ...
        if(powerMeasurementStr == "Average") {
            ...
            throw std::invalid_argument(
                "Received power measurement type (Bit 3) string has invalid value, must be either Average or OMA"
            );
        }
    ...
    nlohmann::ordered_json Enhanced_OptionsToJSON(const Enhanced_Options& value) {
        ...
        j["Optional soft TX_DISABLE control and monitoring implemented (Bit 6)"] =
            value.optional_soft_TX_DISABLE_control_and_monitoring_implemented_bit_6;
        j["Optional soft TX_FAULT monitoring implemented (Bit 5)"] =
            value.optional_soft_TX_FAULT_monitoring_implemented_bit_5;
        j["Optional soft RX_LOS monitoring implemented (Bit 4)"] =
            value.optional_soft_RX_LOS_monitoring_implemented_bit_4;
        j["Optional soft RATE_SELECT control and monitoring implemented (Bit 3)"] =
            value.optional_soft_RATE_SELECT_control_and_monitoring_implemented_bit_3;
        j["Optional Application Select control implemented per SFF-8079 (Bit 2)"] =
            value.optional_application_select_control_implemented_per_SFF_8079_bit_2;
        j["Optional soft Rate Select control implemented per SFF-8431 (Bit 1)"] =
            value.optional_soft_rate_select_control_implemented_per_SFF_8431_bit_1;
        j["Reserved (Bit 0)"] = value.reserved_bit_0;
    ...
    Enhanced_Options Enhanced_OptionsFromJSON(const nlohmann::json& j) {
        ...
        value.optional_alarm_warning_flags_implemented_bit_7 =
            j.at("Optional Alarm/warning flags implemented (Bit 7)").template get<bool>();
        value.optional_soft_TX_DISABLE_control_and_monitoring_implemented_bit_6 =
            j.at("Optional soft TX_DISABLE control and monitoring implemented (Bit 6)").template get<bool>();
        value.optional_soft_TX_FAULT_monitoring_implemented_bit_5 =
            j.at("Optional soft TX_FAULT monitoring implemented (Bit 5)").template get<bool>();
        value.optional_soft_RX_LOS_monitoring_implemented_bit_4 =
            j.at("Optional soft RX_LOS monitoring implemented (Bit 4)").template get<bool>();
        value.optional_soft_RATE_SELECT_control_and_monitoring_implemented_bit_3 =
            j.at("Optional soft RATE_SELECT control and monitoring implemented (Bit 3)").template get<bool>();
        value.optional_application_select_control_implemented_per_SFF_8079_bit_2 =
            j.at("Optional Application Select control implemented per SFF-8079 (Bit 2)").template get<bool>();
        value.optional_soft_rate_select_control_implemented_per_SFF_8431_bit_1 =
            j.at("Optional soft Rate Select control implemented per SFF-8431 (Bit 1)").template get<bool>();
        value.reserved_bit_0 = j.at("Reserved (Bit 0)").template get<bool>();
    ...
    nlohmann::ordered_json SFF_8472_ComplianceToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8472::SFF_8472_ComplianceAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char SFF_8472_ComplianceFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            if(it == SFF8472::SFF_8472_ComplianceAssignedValues.end()) {
                throw std::invalid_argument("SFF-8472 Compliance is not a known string value");
            }
    ...
    std::optional<unsigned char> CC_EXTChecksumFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            auto strValue = j.template get<std::string>();
            if(strValue != "auto") {
                throw std::invalid_argument("CC_EXT string value must be auto");
            }
    ...
    std::array<unsigned char, 32> VendorSpecificFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Vendor Specific must be a base64 object");
        }

        std::array<unsigned char, 32> arr;

        if(j.at("Type").template get<std::string>() != "Base64") {
            throw std::invalid_argument("Vendor Specific object must have Type Base64");
        }
        ...
        if(decoded.size() != 32) {
            throw std::invalid_argument("Vendor Specific specified as base64 must have exactly 32 characters!");
        }
    ...
    void SFF8472_LowerA0hToJSON(nlohmann::ordered_json& j, const SFF8472_LowerA0h& programming, bool fiberMode) {
        ...
        binaryBuffer.resize(128, 0x00);
        // Use MANUAL_USE_VALUE_IN_PROGRAMMING to avoid double calculation of checksum - we don't want to seek it in the
        // binary
        assembleToBinary(
            binaryBuffer.data(),
            programming,
        ...
        j["10G Ethernet Compliance Codes"] =
            _10G_Ethernet_Compliance_CodesToJSON(programming.byte_3_ethernet_compliance_codes);
        j["Infiniband Compliance Codes"] =
            Infiniband_Compliance_CodesToJSON(programming.byte_3_infiniband_compliance_codes);
        ...
        j["Fibre Channel Link Length"] =
            Fibre_Channel_Link_Length_CodesToJSON(programming.byte_7_fibre_channel_link_length_codes);
        j["Fibre Channel Technology"] =
            Fibre_Channel_Technology_CodesToJSON(programming.byte_7_8_fibre_channel_technology_codes);
        j["SFP+ Cable Technology"] =
            SFP_plus_Cable_Technology_CodesToJSON(programming.byte_8_sfp_plus_cable_technology_codes);

        j["Fibre Channel Transmission Media"] =
            Fibre_Channel_Transmission_Media_CodesToJSON(programming.byte_9_fibre_channel_transmission_media_codes);
        ...
        j["Nominal Signaling Rate [MBaud] (Divisible by 100)"] =
            NominalSignalingRate100MBaudToJSON(programming.byte_12_nominal_signaling_rate_in_100_mbaud);
        ...
        j["Extended Specification Compliance Codes"] =
            ExtendedComplianceCodesToJSON(programming.byte_36_extended_specification_compliance_codes);
        ...
        j["Diagnostic Monitoring Type"] =
            Diagnostic_Monitoring_TypeToJSON(programming.byte_92_diagnostic_monitoring_type);
    ...
    void SFF8472_LowerA0hFromJSON(const nlohmann::json& j, SFF8472_LowerA0h& programming) {
        ...
        programming.byte_3_ethernet_compliance_codes =
            _10G_Ethernet_Compliance_CodesFromJSON(j.at("10G Ethernet Compliance Codes"));
        programming.byte_3_infiniband_compliance_codes =
            Infiniband_Compliance_CodesFromJSON(j.at("Infiniband Compliance Codes"));
        ...
        programming.byte_6_ethernet_compliance_codes =
            Ethernet_Compliance_CodesFromJSON(j.at("Ethernet Compliance Codes"));

        programming.byte_7_fibre_channel_link_length_codes =
            Fibre_Channel_Link_Length_CodesFromJSON(j.at("Fibre Channel Link Length"));
        programming.byte_7_8_fibre_channel_technology_codes =
            Fibre_Channel_Technology_CodesFromJSON(j.at("Fibre Channel Technology"));
        programming.byte_8_sfp_plus_cable_technology_codes =
            SFP_plus_Cable_Technology_CodesFromJSON(j.at("SFP+ Cable Technology"));

        programming.byte_9_fibre_channel_transmission_media_codes =
            Fibre_Channel_Transmission_Media_CodesFromJSON(j.at("Fibre Channel Transmission Media"));
        ...
        programming.byte_12_nominal_signaling_rate_in_100_mbaud =
            NominalSignalingRate100MBaudFromJSON(j.at("Nominal Signaling Rate [MBaud] (Divisible by 100)"));
        ...
        programming.byte_14_length_smf_in_kilometers_or_copper_attenuation_in_db_at_12_9_ghz =
            linkLengthReturn.byte_14_length_smf_in_kilometers_or_copper_attenuation_in_db_at_12_9_ghz;
        programming.byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz =
            linkLengthReturn.byte_15_length_smf_in_100_m_or_copper_attenuation_in_db_at_25_78_ghz;
        ...
        programming.byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m =
            linkLengthReturn.byte_18_link_length_om4_10m_or_copper_or_dac_length_in_m;
        programming.byte_19_length_om3_in_10m_or_copper_or_dac_multiplier_and_base_value =
            linkLengthReturn.byte_19_length_om3_in_10m_or_copper_or_dac_multiplier_and_base_value;

        programming.byte_20_35_vendor_name = VendorNameFromJSON(j.at("Vendor Name"));

        programming.byte_36_extended_specification_compliance_codes =
            ExtendedComplianceCodesFromJSON(j.at("Extended Specification Compliance Codes"));
        ...
        auto WavelengthOrCableSpecificationComplianceFromJSONReturn =
            WavelengthOrCableSpecificationComplianceFromJSON(j.at("Wavelength Or Cable Specification Compliance"));
        programming.byte_60_wavelength_high_order_byte_or_cable_specification_compliance =
            WavelengthOrCableSpecificationComplianceFromJSONReturn
                .byte_60_wavelength_high_order_byte_or_cable_specification_compliance;
        programming.byte_61_wavelength_low_order_byte_or_cable_specification_compliance =
            WavelengthOrCableSpecificationComplianceFromJSONReturn
                .byte_61_wavelength_low_order_byte_or_cable_specification_compliance;

        programming.byte_62_fibre_channel_2_speed_codes =
            Fibre_Channel_Speed_2_CodesFromJSON(j.at("Fibre Channel Speed 2"));

        // CC_BASE is done later

        std::tie(programming.byte_64_option_values, programming.byte_65_option_values) =
            OptionValuesFromJSON(j.at("Option Values"));

        auto extendedSignalingRateInfoFromJSONReturn = ExtendedSignalingRateFromJSON(j.at("Extended Signaling Rate"));
        programming.byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud =
            extendedSignalingRateInfoFromJSONReturn
                .byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud;
        programming.byte_67_min_signaling_rate_in_percent_or_range_of_signaling_rates_in_percent =
            extendedSignalingRateInfoFromJSONReturn
                .byte_67_min_signaling_rate_in_percent_or_range_of_signaling_rates_in_percent;
        ...
        programming.byte_92_diagnostic_monitoring_type =
            Diagnostic_Monitoring_TypeFromJSON(j.at("Diagnostic Monitoring Type"));
