...
namespace TransceiverTool::Standards::SFF8636 {
    ...
    nlohmann::ordered_json TransceiverReferenceToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8024::TransceiverReferenceAssignedValue& entry) {
    ...
    nlohmann::ordered_json Extended_IdentifierToJSON(const Extended_Identifier& extIdentifier) {
        ...
        j["Power Class (Bit 7-6)"] =
            getSFF8636_Extended_Identifier_Bit_7_6Info(extIdentifier.power_class_bit_7_6).description;
        ...
        j["Extended Power Class (Bit 1-0)"] =
            getSFF8636_Extended_Identifier_Bit_1_0Info(extIdentifier.power_class_bit_1_0).description;
    ...
    Extended_Identifier Extended_IdentifierFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Extended Identifier must be an object");
        }
        ...
        auto power_class_bit_7_6It = std::find_if(
            ...
            [&power_class_bit_7_6_str](const Extended_Identifier_Bit_7_6_string& value) {
                return value.description == power_class_bit_7_6_str;
            }
        );
        ...
        auto power_class_bit_1_0It = std::find_if(
            ...
            [&power_class_bit_1_0_str](const Extended_Identifier_Bit_1_0_string& value) {
                return value.description == power_class_bit_1_0_str;
            }
        );
    ...
    // ############
    nlohmann::ordered_json _10_40G_100G_Ethernet_Compliance_CodesToJSON(
        const _10_40G_100G_Ethernet_Compliance_Codes& value
    ) {
        nlohmann::ordered_json j;
    ...
    _10_40G_100G_Ethernet_Compliance_Codes _10_40G_100G_Ethernet_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("10/40G/100G Ethernet Compliance Codes must be an object");
        }
        ...
        complianceCodes._40G_Active_Cable_XLPPI_bit_0 =
            j.at("40G Active Cable (XLPPI) compliant (Bit 0)").template get<bool>();
    ...
    SONET_Compliance_Codes SONET_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("SONET Compliance Codes Compliance Codes must be an object");
        }
        ...
        complianceCodes.OC48_intermediate_reach_bit_1 =
            j.at("OC 48, intermediate reach compliant (Bit 1)").template get<bool>();
    ...
    SAS_SATA_Compliance_Codes SAS_SATA_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("SAS/SATA Compliance Codes must be an object");
        }
    ...
    Gigabit_Ethernet_Compliance_Codes Gigabit_Ethernet_Compliance_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Gigabit Ethernet Compliance Codes must be an object");
        }
    ...
    std::pair<nlohmann::json, nlohmann::json> Fibre_Channel_Link_Length_And_Transmitter_TechnologyToJSON(
        ...
        jlinkValue["Very long distance (V) compliant (Byte 135, Bit 7)"] =
            linkAndTransmitterValue.Very_long_distance_V_bit_7;
        jlinkValue["Short distance (S) compliant (Byte 135, Bit 6)"] = linkAndTransmitterValue.Short_distance_S_bit_6;
        jlinkValue["Intermediate distance (I) compliant (Byte 135, Bit 5)"] =
            linkAndTransmitterValue.Intermediate_distance_I_bit_5;
        ...
        jtransmitterValue["Longwave laser (LC) compliant (Byte 135, Bit 1)"] =
            linkAndTransmitterValue.Longwave_laser_LC_bit_1;
        jtransmitterValue["Electrical inter-enclosure (EL) compliant (Byte 135, Bit 0)"] =
            linkAndTransmitterValue.Electrical_inter_enclosure_EL_bit_0;
        jtransmitterValue["Electrical intra-enclosure compliant (Byte 136, Bit 7)"] =
            transmitterValue.Electrical_intra_enclosure_bit_7;
        jtransmitterValue["Shortwave laser w/o OFC (SN) compliant (Byte 136, Bit 6)"] =
            transmitterValue.Shortwave_laser_w_o_OFC_SN_bit_6;
        jtransmitterValue["Shortwave laser w OFC (SL) compliant (Byte 136, Bit 5)"] =
            transmitterValue.Shortwave_laser_w_OFC_SL_bit_5;
    ...
    std::pair<Fibre_Channel_Link_Length_And_Transmitter_Technology, Fibre_Channel_Transmitter_Technology>
    Fibre_Channel_Link_Length_And_Transmitter_TechnologyFromJSON(
        const nlohmann::json& jlinkValue,
        const nlohmann::json& jtransmitterValue
    ) {
        if(!jlinkValue.is_object()) {
            throw std::invalid_argument("Fibre Channel Link Length must be an object");
        }
        if(!jtransmitterValue.is_object()) {
            throw std::invalid_argument("Fibre Channel Transmitter Technology must be an object");
        }
        ...
        linkAndTransmitterValue.Very_long_distance_V_bit_7 =
            jlinkValue.at("Very long distance (V) compliant (Byte 135, Bit 7)").template get<bool>();
        linkAndTransmitterValue.Short_distance_S_bit_6 =
            jlinkValue.at("Short distance (S) compliant (Byte 135, Bit 6)").template get<bool>();
        linkAndTransmitterValue.Intermediate_distance_I_bit_5 =
            jlinkValue.at("Intermediate distance (I) compliant (Byte 135, Bit 5)").template get<bool>();
        linkAndTransmitterValue.Long_distance_L_bit_4 =
            jlinkValue.at("Long distance (L) compliant (Byte 135, Bit 4)").template get<bool>();
        linkAndTransmitterValue.Medium_M_bit_3 =
            jlinkValue.at("Medium distance (M) compliant (Byte 135, Bit 3)").template get<bool>();
        linkAndTransmitterValue.reserved_Transmitter_Technology_bit_2 =
            jtransmitterValue.at("Reserved (Byte 135, Bit 2)").template get<bool>();
        linkAndTransmitterValue.Longwave_laser_LC_bit_1 =
            jtransmitterValue.at("Longwave laser (LC) compliant (Byte 135, Bit 1)").template get<bool>();
        linkAndTransmitterValue.Electrical_inter_enclosure_EL_bit_0 =
            jtransmitterValue.at("Electrical inter-enclosure (EL) compliant (Byte 135, Bit 0)").template get<bool>();

        transmitterValue.Electrical_intra_enclosure_bit_7 =
            jtransmitterValue.at("Electrical intra-enclosure compliant (Byte 136, Bit 7)").template get<bool>();
        transmitterValue.Shortwave_laser_w_o_OFC_SN_bit_6 =
            jtransmitterValue.at("Shortwave laser w/o OFC (SN) compliant (Byte 136, Bit 6)").template get<bool>();
        transmitterValue.Shortwave_laser_w_OFC_SL_bit_5 =
            jtransmitterValue.at("Shortwave laser w OFC (SL) compliant (Byte 136, Bit 5)").template get<bool>();
        transmitterValue.Longwave_Laser_LL_bit_4 =
            jtransmitterValue.at("Longwave Laser (LL) compliant (Byte 136, Bit 4)").template get<bool>();
    ...
    Fibre_Channel_Transmission_Media Fibre_Channel_Transmission_MediaFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Fibre Channel Transmission Media must be an object");
        }
        ...
        complianceCodes.Shielded_Twisted_Pair_TP_bit_6 =
            j.at("Shielded Twisted Pair (TP) compliant (Bit 6)").template get<bool>();
        ...
        complianceCodes.Multi_mode_62_5_um_M6_bit_3 =
            j.at("Multi-mode 62.5 um (M6) compliant (Bit 3)").template get<bool>();
        complianceCodes.Multi_mode_50_um_M5_bit_2 =
            j.at("Multi-mode 50 um (M5) compliant (Bit 1)").template get<bool>();
        complianceCodes.Multi_mode_50_um_OM3_bit_1 =
            j.at("Multi-mode 50 um (OM3) compliant (Bit 1)").template get<bool>();
    ...
    Fibre_Channel_Speed Fibre_Channel_SpeedFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Fibre Channel Speed must be an object");
        }

        Fibre_Channel_Speed complianceCodes;

        complianceCodes._1200_MBps_per_channel_bit_7 =
            j.at("1200 MBps (per channel) compliant (Bit 7)").template get<bool>();
        complianceCodes._800_MBps_bit_6 = j.at("800 MBps compliant (Bit 6)").template get<bool>();
        complianceCodes._1600_MBps_per_channel_bit_5 =
            j.at("1600 MBps (per channel) compliant (Bit 5)").template get<bool>();
        complianceCodes._400_MBps_bit_4 = j.at("400 MBps compliant (Bit 4)").template get<bool>();
        complianceCodes._3200_MBps_per_channel_bit_3 =
            j.at("3200 MBps (per channel) compliant (Bit 3)").template get<bool>();
    ...
    nlohmann::ordered_json EncodingToJSON(unsigned char byte_value) {
        ...
        auto it = std::find_if(
            ...
            [byte_value](const SFF8024::SFF8636TransceiverEncodingAssignedValue& entry) {
                return entry.byte_value == byte_value;
            }
        );
    ...
    unsigned char EncodingFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            ...
            auto it = std::find_if(
                SFF8024::SFF8636TransceiverEncodingAssignedValues.begin(),
                SFF8024::SFF8636TransceiverEncodingAssignedValues.end(),
                [&strValue](const SFF8024::SFF8636TransceiverEncodingAssignedValue& entry) {
                    return entry.name == strValue;
                }
            );
    ...
    // ############
    nlohmann::ordered_json Extended_Rate_Select_ComplianceToJSON(
        const Extended_Rate_Select_Compliance& extRateSelectCompliance
    ) {
        nlohmann::ordered_json j;
        ...
        j["Rate Select Version (Bit 1-0)"] =
            getSFF8636_Extended_Rate_Select_Compliance_Bit_1_0Info(extRateSelectCompliance.rate_select_bits_1_0)
                .description;
    ...
    Extended_Rate_Select_Compliance Extended_Rate_Select_ComplianceJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Extended Rate Select Compliance must be an object");
        }
        ...
        auto rate_select_bits_1_0It = std::find_if(
            ...
            [&rate_select_bits_1_0_str](const Extended_Rate_Select_Compliance_Bit_1_0_string& value) {
                return value.description == rate_select_bits_1_0_str;
            }
        );
    ...
    unsigned char LengthSMFkmFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            if(numberValue > 255) {
                throw std::invalid_argument("Length (Standard SM Fiber) [km] must not be larger than 255");
            }

            return numberValue;
        } else {
            throw std::invalid_argument(
                "Length (Standard SM Fiber) [km] has wrong type (neither string nor unsigned integer)"
            );
        }
    }
    // ############
    ...
    unsigned char LengthOM3mFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            if(numberValue % 2 != 0) {
                throw std::invalid_argument("Length (OM3 50 um) [m] (Divisible by 2) must be divisble by 2");
            }
            if(numberValue > 510) {
                throw std::invalid_argument("Length (OM3 50 um) [m] (Divisible by 2) must not be larger than 510");
            }

            return numberValue / 2;
        } else {
            throw std::invalid_argument(
                "Length (OM3 50 um) [m] (Divisible by 2) has wrong type (neither string nor unsigned integer)"
            );
        }
    }
    // ############
    ...
    unsigned char LengthOM2mFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            if(numberValue > 255) {
                throw std::invalid_argument("Length (OM2 50 um) [m] must not be larger than 255");
            }
    ...
    nlohmann::ordered_json CopperOrFibreInfoToJSON(
        ...
        if(fiberMode) {
            ...
            if(byte_145_length_om1_in_1m_or_copper_cable_attenuation_in_dB == 0) {
                ...
                j["Length (OM1 62.5 um) [m]"] =
                    (unsigned long)(byte_145_length_om1_in_1m_or_copper_cable_attenuation_in_dB);
            }
            ...
            if(byte_146_length_copper_in_1m_or_om4_in_2m == 0xFF) {
                ...
                j["Length (OM4 50 um) [m] (Divisible by 2)"] =
                    (unsigned long)(byte_146_length_copper_in_1m_or_om4_in_2m) * 2ul;
            }
            ...
            if(byte_146_length_copper_in_1m_or_om4_in_2m == 0xFF) {
                ...
                j["Length (passive copper or active cable) [m]"] =
                    (unsigned long)(byte_146_length_copper_in_1m_or_om4_in_2m);
            }

            if(byte_186_wavelength_high_order_or_copper_attenuation == 0) {
                j["Copper Cable Attenuation @ 2.5 GHz [dB]"] = "N/A";
            } else {
                j["Copper Cable Attenuation @ 2.5 GHz [dB]"] =
                    (unsigned long)(byte_186_wavelength_high_order_or_copper_attenuation);
            }

            if(byte_187_wavelength_low_order_or_copper_attenuation == 0) {
                j["Copper Cable Attenuation @ 5.0 GHz [dB]"] = "N/A";
            } else {
                j["Copper Cable Attenuation @ 5.0 GHz [dB]"] =
                    (unsigned long)(byte_187_wavelength_low_order_or_copper_attenuation);
            }

            if(byte_188_wavelength_tolerance_high_order_or_copper_attenuation == 0) {
                j["Copper Cable Attenuation @ 7.0 GHz [dB]"] = "N/A";
            } else {
                j["Copper Cable Attenuation @ 7.0 GHz [dB]"] =
                    (unsigned long)(byte_188_wavelength_tolerance_high_order_or_copper_attenuation);
            }
            ...
            if(byte_189_wavelength_tolerance_low_order_or_copper_attenuation == 0) {
                ...
                j["Copper Cable Attenuation @ 12.9 GHz [dB]"] =
                    (unsigned long)(byte_189_wavelength_tolerance_low_order_or_copper_attenuation);
            }
        }
    ...
    CopperOrFibreInfoFromJSONReturn CopperOrFibreInfoFromJSON(const nlohmann::json& j) {
        ...
        if(!j.is_object()) {
            throw std::invalid_argument("Copper or Fibre Properties must be an object");
        }
        ...
        if(typeStr == "Copper") {
            ...
            if(copper_cable_attenuation_25ghz_val.is_string()) {
                if(copper_cable_attenuation_25ghz_val.template get<std::string>() != "N/A") {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 25.78 GHz [dB] has string value, must be N/A"
                    );
                }
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 25.78 GHz [dB] must not be greater than 255"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Copper Cable Attenuation @ 25.78 GHz [dB] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(cable_length_val.is_string()) {
                if(cable_length_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (passive copper or active cable) [m] has string value, must be N/A or > 254 m"
                    );
                }
                ...
                if(numberValue > 254) {
                    throw std::invalid_argument(
                        "Length (passive copper or active cable) [m] must not be greater than 254"
                    );
                }
                ...
                throw std::invalid_argument(
                    "Length (passive copper or active cable) [m] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(copper_cable_attenuation_2_5ghz_val.is_string()) {
                if(copper_cable_attenuation_2_5ghz_val.template get<std::string>() != "N/A") {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 2.5 GHz [dB] has string value, must be N/A"
                    );
                }
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument("Copper Cable Attenuation @ 2.5 GHz [dB] must not be greater than 255");
                }

                parsedStruct.byte_186_wavelength_high_order_or_copper_attenuation = numberValue;
            } else {
                throw std::invalid_argument(
                    "Copper Cable Attenuation @ 2.5 GHz [dB] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(copper_cable_attenuation_5_0ghz_val.is_string()) {
                if(copper_cable_attenuation_5_0ghz_val.template get<std::string>() != "N/A") {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 5.0 GHz [dB] has string value, must be N/A"
                    );
                }
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument("Copper Cable Attenuation @ 5.0 GHz [dB] must not be greater than 255");
                }

                parsedStruct.byte_187_wavelength_low_order_or_copper_attenuation = numberValue;
            } else {
                throw std::invalid_argument(
                    "Copper Cable Attenuation @ 5.0 GHz [dB] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(copper_cable_attenuation_7_0ghz_val.is_string()) {
                if(copper_cable_attenuation_7_0ghz_val.template get<std::string>() != "N/A") {
                    throw std::invalid_argument(
                        "Copper Cable Attenuation @ 7.0 GHz [dB] has string value, must be N/A"
                    );
                }
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument("Copper Cable Attenuation @ 7.0 GHz [dB] must not be greater than 255");
                }

                parsedStruct.byte_188_wavelength_tolerance_high_order_or_copper_attenuation = numberValue;
            } else {
                throw std::invalid_argument(
                    "Copper Cable Attenuation @ 7.0 GHz [dB] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_om1_val.is_string()) {
                ...
                if(numberValue > 255) {
                    throw std::invalid_argument("Length (OM1 62.5 um) [m] must not be greater than 255");
                }

                parsedStruct.byte_145_length_om1_in_1m_or_copper_cable_attenuation_in_dB = numberValue;
            } else {
                throw std::invalid_argument(
                    "Length (OM1 62.5 um) [m] has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(length_om4_val.is_string()) {
                if(length_om4_val.template get<std::string>() == "N/A") {
                    ...
                    throw std::invalid_argument(
                        "Length (OM4 50 um) [m] (Divisible by 2) has string value, must be N/A or > 508 m"
                    );
                }
                ...
                if(numberValue % 2 != 0) {
                    throw std::invalid_argument("Length (OM4 50 um) [m] (Divisible by 2) must be divisible by 2");
                }
                if(numberValue > 508) {
                    throw std::invalid_argument("Length (OM4 50 um) [m] (Divisible by 2) must not be greater than 508");
                }

                parsedStruct.byte_146_length_copper_in_1m_or_om4_in_2m = numberValue / 2;
            } else {
                throw std::invalid_argument(
                    "Length (OM4 50 um) [m] (Divisible by 2) has wrong type (neither string nor unsigned integer)"
                );
            }
            ...
            if(rawWavelength < 0.0) {
                throw std::invalid_argument("Wavelength [nm] (Divisible by 0.05) must be positive");
            }
            if(rawWavelength > 3276.75) {
                throw std::invalid_argument("Wavelength [nm] (Divisible by 0.05) must not be greater than 3276.75");
            }
            // Allow for some FP rounding error due to round trip
            if(std::abs(rawWavelength / 0.05 - std::round(rawWavelength / 0.05)) > 1e-04) {
                throw std::invalid_argument("Wavelength [nm] (Divisible by 0.05) must be divisible by 0.05");
            }
            ...
            if(rawWavelengthTolerance < 0.0) {
                throw std::invalid_argument("Wavelength Tolerance [nm] (Divisible by 0.005) must be positive");
            }
            if(rawWavelengthTolerance > 327.675) {
                throw std::invalid_argument(
                    "Wavelength Tolerance [nm] (Divisible by 0.005) must not be greater than 327.675"
                );
            }
            // Allow for some FP rounding error due to round trip
            if(std::abs(rawWavelengthTolerance / 0.005 - std::round(rawWavelengthTolerance / 0.005)) > 1e-04) {
                throw std::invalid_argument("Wavelength [nm] (Divisible by 0.005) must be divisible by 0.005");
            }

            unsigned int wavelengthToleranceUint = std::min(65535.0, std::round(rawWavelengthTolerance * 200.0));

            parsedStruct.byte_188_wavelength_tolerance_high_order_or_copper_attenuation =
                (wavelengthToleranceUint >> 8) & (0b11111111);
            parsedStruct.byte_189_wavelength_tolerance_low_order_or_copper_attenuation =
                (wavelengthToleranceUint >> 0) & (0b11111111);
    ...
    // ############
    nlohmann::ordered_json Device_Technology_and_Transmitter_TechnologyToJSON(
        const Device_Technology_and_Transmitter_Technology& value
    ) {
        nlohmann::ordered_json j;

        j["Transmitter Technology (Bit 7-4)"] =
            getSFF8636_Transmitter_Technology_bit_7_4Info(value.transmitter_Technology_bit_7_4).description;
    ...
    Device_Technology_and_Transmitter_Technology Device_Technology_and_Transmitter_TechnologyFromJSON(
        const nlohmann::json& j
    ) {
        if(!j.is_object()) {
            throw std::invalid_argument("Device & Transmitter Properties must be an object");
        }
        ...
        auto it = std::find_if(
            ...
            [&transmitterTechnologyStr](const Transmitter_Technology_bit_7_4_string& entry) {
                return entry.description == transmitterTechnologyStr;
            }
        );

        if(it == Transmitter_Technology_bit_7_4_strings.end()) {
            throw std::invalid_argument("Transmitter Technology is not a known string value");
        }
    ...
    Extended_Module_Codes Extended_Module_CodesFromJSON(const nlohmann::json& j) {
        if(!j.is_object()) {
            throw std::invalid_argument("Extended Module Codes (Infiniband) must be an object");
        }
    ...
    std::array<unsigned char, 2> VendorRevFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            // valid. Let the user enter what they want...
            if(strVal.size() > 2) {
                throw std::invalid_argument("Vendor Rev must not have more than 2 characters");
            }

            if(strVal.size() < 2) {
                strVal.resize(2, 0x20);
            }
    ...
    unsigned char MaxCaseTemperatureFromJSON(const nlohmann::json& j) {
        if(j.is_string()) {
            auto strValue = j.template get<std::string>();
            if(strValue != "default") {
                throw std::invalid_argument("Maximum Case Temperature [degC] string value must be default");
            }
            ...
            if(numberValue > 255) {
                throw std::invalid_argument("Maximum Case Temperature [degC] must not be larger than 255");
            }
    ...
    // ############
    nlohmann::ordered_json OptionsToJSON(
        const Option_Values_Byte_193& byte_193_option_values,
        const Option_Values_Byte_194& byte_194_option_values,
        const Option_Values_Byte_195& byte_195_option_values
    ) {
        nlohmann::ordered_json j;

        j["Reserved (Byte 193, Bit 7)"] = byte_193_option_values.reserved_bit_7;
        j["LPMode/TxDis input signal configurable (Byte 193, Bit 6)"] =
            byte_193_option_values.lpmode_txdis_input_configurable_bit_6;
        j["IntL/RxLOSL output signal configurable (Byte 193, Bit 5)"] =
            byte_193_option_values.intl_rxlosl_output_configurable_bit_5;
        j["Tx input adaptive equalizers freeze capable (Byte 193, Bit 4)"] =
            byte_193_option_values.tx_input_adaptive_equalizers_freeze_capable_bit_4;
        j["Tx input equalizers auto-adaptive capable (Byte 193, Bit 3)"] =
            byte_193_option_values.tx_input_equalizers_auto_adaptive_capable_bit_3;
        j["Tx input equalizers fixed-programmable settings implemented (Byte 193, Bit 2)"] =
            byte_193_option_values.tx_input_equalizers_fixed_programmable_settings_bit_2;
        j["Rx output emphasis fixed-programmable settings implemented (Byte 193, Bit 1)"] =
            byte_193_option_values.rx_output_emphasis_fixed_programmable_settings_bit_1;
        j["Rx output amplitude fixed-programmable settings implemented (Byte 193, Bit 0)"] =
            byte_193_option_values.rx_output_amplitude_fixed_programmable_settings_bit_0;

        j["Tx CDR On/Off Control implemented (Byte 194, Bit 7)"] =
            byte_194_option_values.tx_cdr_on_off_control_implemented_bit_7;
        j["Rx CDR On/Off Control implemented (Byte 194, Bit 6)"] =
            byte_194_option_values.rx_cdr_on_off_control_implemented_bit_6;
        j["Tx CDR Loss of Lock (LOL) flag implemented (Byte 194, Bit 5)"] =
            byte_194_option_values.tx_cdr_loss_of_lock_lol_flag_implemented_bit_5;
        j["Rx CDR Loss of Lock (LOL) flag implemented. (Byte 194, Bit 4)"] =
            byte_194_option_values.rx_cdr_loss_of_lock_lol_flag_implemented_bit_4;
        j["Rx Squelch Disable implemented (Byte 194, Bit 3)"] =
            byte_194_option_values.rx_squelch_disable_implemented_bit_3;
        j["Rx Output Disable implemented (Byte 194, Bit 2)"] =
            byte_194_option_values.rx_output_disable_implemented_bit_2;
        j["Tx Squelch Disable implemented (Byte 194, Bit 1)"] =
            byte_194_option_values.tx_squelch_disable_implemented_bit_1;
        ...
        j["Rate select is implemented as defined in Section 6.2.7 (Byte 195, Bit 5)"] =
            byte_195_option_values.rate_select_implemented_bit_5;
        ...
        j["Tx Squelch implemented to reduce Pave (Byte 195, Bit 2)"] =
            byte_195_option_values.tx_squelch_implemented_to_reduce_pave_bit_2;
    ...
    std::tuple<Option_Values_Byte_193, Option_Values_Byte_194, Option_Values_Byte_195> OptionsFromJSON(
        const nlohmann::json& j
    ) {
        if(!j.is_object()) {
        ...
        byte_193_option_values.lpmode_txdis_input_configurable_bit_6 =
            j.at("LPMode/TxDis input signal configurable (Byte 193, Bit 6)").template get<bool>();
        byte_193_option_values.intl_rxlosl_output_configurable_bit_5 =
            j.at("IntL/RxLOSL output signal configurable (Byte 193, Bit 5)").template get<bool>();
        byte_193_option_values.tx_input_adaptive_equalizers_freeze_capable_bit_4 =
            j.at("Tx input adaptive equalizers freeze capable (Byte 193, Bit 4)").template get<bool>();
        byte_193_option_values.tx_input_equalizers_auto_adaptive_capable_bit_3 =
            j.at("Tx input equalizers auto-adaptive capable (Byte 193, Bit 3)").template get<bool>();
        byte_193_option_values.tx_input_equalizers_fixed_programmable_settings_bit_2 =
            j.at("Tx input equalizers fixed-programmable settings implemented (Byte 193, Bit 2)").template get<bool>();
        byte_193_option_values.rx_output_emphasis_fixed_programmable_settings_bit_1 =
            j.at("Rx output emphasis fixed-programmable settings implemented (Byte 193, Bit 1)").template get<bool>();
        byte_193_option_values.rx_output_amplitude_fixed_programmable_settings_bit_0 =
            j.at("Rx output amplitude fixed-programmable settings implemented (Byte 193, Bit 0)").template get<bool>();

        byte_194_option_values.tx_cdr_on_off_control_implemented_bit_7 =
            j.at("Tx CDR On/Off Control implemented (Byte 194, Bit 7)").template get<bool>();
        byte_194_option_values.rx_cdr_on_off_control_implemented_bit_6 =
            j.at("Rx CDR On/Off Control implemented (Byte 194, Bit 6)").template get<bool>();
        byte_194_option_values.tx_cdr_loss_of_lock_lol_flag_implemented_bit_5 =
            j.at("Tx CDR Loss of Lock (LOL) flag implemented (Byte 194, Bit 5)").template get<bool>();
        byte_194_option_values.rx_cdr_loss_of_lock_lol_flag_implemented_bit_4 =
            j.at("Rx CDR Loss of Lock (LOL) flag implemented. (Byte 194, Bit 4)").template get<bool>();
        byte_194_option_values.rx_squelch_disable_implemented_bit_3 =
            j.at("Rx Squelch Disable implemented (Byte 194, Bit 3)").template get<bool>();
        byte_194_option_values.rx_output_disable_implemented_bit_2 =
            j.at("Rx Output Disable implemented (Byte 194, Bit 2)").template get<bool>();
        byte_194_option_values.tx_squelch_disable_implemented_bit_1 =
            j.at("Tx Squelch Disable implemented (Byte 194, Bit 1)").template get<bool>();
        byte_194_option_values.tx_squelch_implemented_bit_0 =
            j.at("Tx Squelch implemented (Byte 194, Bit 0)").template get<bool>();

        byte_195_option_values.memory_page_02_provided_bit_7 =
            j.at("Memory Page 02 provided (Byte 195, Bit 7)").template get<bool>();
        byte_195_option_values.memory_page_01h_provided_bit_6 =
            j.at("Memory Page 01h provided. (Byte 195, Bit 6)").template get<bool>();
        byte_195_option_values.rate_select_implemented_bit_5 =
            j.at("Rate select is implemented as defined in Section 6.2.7 (Byte 195, Bit 5)").template get<bool>();
        byte_195_option_values.tx_disable_implemented_bit_4 =
            j.at("Tx_Disable is implemented (Byte 195, Bit 4)").template get<bool>();
        byte_195_option_values.tx_fault_signal_implemented_bit_3 =
            j.at("Tx_Fault signal implemented (Byte 195, Bit 3)").template get<bool>();
        byte_195_option_values.tx_squelch_implemented_to_reduce_pave_bit_2 =
            j.at("Tx Squelch implemented to reduce Pave (Byte 195, Bit 2)").template get<bool>();
        byte_195_option_values.tx_loss_of_signal_implemented_bit_1 =
            j.at("Tx Loss of Signal (Byte 195, Bit 1)").template get<bool>();
        byte_195_option_values.pages_20_to_21h_implemented_bit_0 =
            j.at("Pages 20-21h implemented (Byte 195, Bit 0)").template get<bool>();

        return std::make_tuple(
            std::move(byte_193_option_values), std::move(byte_194_option_values), std::move(byte_195_option_values)
        );
    }
    ...
    nlohmann::ordered_json DateCodeToJSON(const DateCode& dateCode) {
        ...
        if(dateCodeYearIsNumber) {
            ...
            j["Year low order digits (Byte 212-213)"]["Value"] = cppcodec::base64_rfc4648::encode(
        ...
        if(dateCodeMonthIsNumber) {
            ...
            if(digits_of_month < 1 || digits_of_month > 12) {
                ...
                j["Month digits (Byte 214-215)"]["Value"] =
        ...
        if(vendorLotCodePrintable) {
            ...
            j["Vendor Lot Code (Byte 218-219)"]["Value"] =
    ...
    DateCode DateCodeFromJSON(const nlohmann::json& j) {
        ...
        if(dateCodeYearVal.is_number_unsigned()) {
            ...
            if(dateCodeNumVal > 99) {
                throw std::invalid_argument("Year low order digits (Byte 212-213) must not be greater than 99");
            }
            ...
            if(dateCodeYearVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Year low order digits (Byte 212-213) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument(
                    "Year low order digits (Byte 212-213) specified as base64 must have exactly 2 characters!"
                );
            }
        ...
        if(dateCodeMonthVal.is_number_unsigned()) {
            ...
            if(dateCodeNumVal > 99) {
                throw std::invalid_argument("Month digits (Byte 214-215) must not be greater than 99");
            }
            ...
            if(dateCodeMonthVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Month digits (Byte 214-215) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument(
                    "Month digits (Byte 214-215) specified as base64 must have exactly 2 characters!"
                );
            }
        ...
        if(dateCodeDayVal.is_number_unsigned()) {
            ...
            if(dateCodeNumVal > 99) {
                throw std::invalid_argument("Day (Byte 216-217) must not be greater than 99");
            }
            ...
            if(dateCodeDayVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Day (Byte 216-217) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument("Day (Byte 216-217) specified as base64 must have exactly 2 characters!");
            }
        ...
        if(dateCodeLotVal.is_string()) {
            ...
            if(dateCodeStrVal.size() > 2) {
                throw std::invalid_argument(
                    "Vendor Lot Code (Byte 218-219) string must not be longer than 2 characters"
                );
            }
            if(dateCodeStrVal.size() < 2) {
            ...
            if(dateCodeLotVal.at("Type").template get<std::string>() != "Base64") {
                throw std::invalid_argument("Vendor Lot Code (Byte 218-219) object must have Type Base64");
            }
            ...
            if(decoded.size() != 2) {
                throw std::invalid_argument(
                    "Vendor Lot Code (Byte 218-219) specified as base64 must have exactly 2 characters!"
                );
            }
    ...
    nlohmann::ordered_json Diagnostic_Monitoring_TypeToJSON(const Diagnostic_Monitoring_Type& value) {
        ...
        j["Received power measurements type (Bit 3)"] =
    ...
    Diagnostic_Monitoring_Type Diagnostic_Monitoring_TypeFromJSON(const nlohmann::json& j) {
        ...
        monitoringType.temperature_monitoring_implemented_bit_5 =
            j.at("Temperature monitoring implemented (Bit 5)").template get<bool>();
        monitoringType.supply_voltage_monitoring_implemented_bit_4 =
            j.at("Supply voltage monitoring implemented (Bit 4)").template get<bool>();
        ...
        if(powerMeasurementStr == "Average") {
            ...
            throw std::invalid_argument(
                "Received power measurements type (Bit 3) string has invalid value, must be either Average or OMA"
            );
        }

        monitoringType.transmitter_power_measurement_supported_bit_2 =
            j.at("Transmitter power measurement supported (Bit 2)").template get<bool>();
    ...
    nlohmann::ordered_json Enhanced_OptionsToJSON(const Enhanced_Options& value) {
        ...
        j["Extended Rate Selection implemented (Bit 3)"] =
            value.rate_selection_is_implemented_using_extended_rate_selection_bit_3;
        j["Reserved (Bit 2)"] = value.reserved_bit_2;
    ...
    Enhanced_Options Enhanced_OptionsFromJSON(const nlohmann::json& j) {
        ...
        enhancedOptions.software_reset_implemented_bit_0 =
            j.at("Software reset implemented (Bit 0)").template get<bool>();
    ...
    unsigned char ExtendedBaudRate250MBaudFromJSON(const nlohmann::json& j) {
        ...
        if(j.is_string()) {
            ...
            if(numberValue % 250 != 0) {
                throw std::invalid_argument("Extended Baud Rate must be divisble by 250");
            }

            if(numberValue > 63750) {
                throw std::invalid_argument("Extended Baud Rate must not be larger than 63750");
            }
    ...
    void SFF8636_Upper00hToJSON(nlohmann::ordered_json& j, const SFF8636_Upper00h& programming, bool fiberMode) {
        ...
        j["10/40G/100G Ethernet Compliance Codes"] =
            _10_40G_100G_Ethernet_Compliance_CodesToJSON(programming.byte_131_ethernet_compliance_codes);
        j["SONET Compliance Codes"] = SONET_Compliance_CodesToJSON(programming.byte_132_sonet_compliance_codes);
        j["SAS/SATA Compliance Codes"] =
            SAS_SATA_Compliance_CodesToJSON(programming.byte_133_sas_sata_compliance_codes);
        j["Gigabit Ethernet Compliance Codes"] =
            Gigabit_Ethernet_Compliance_CodesToJSON(programming.byte_134_gigabit_ethernet_compliance_codes);
        ...
        j["Fibre Channel Transmission Media"] =
            Fibre_Channel_Transmission_MediaToJSON(programming.byte_137_fibre_channel_transmission_media);
        ...
        j["Nominal Signaling Rate [MBaud] (Divisible by 100)"] =
            NominalSignalingRate100MBaudToJSON(programming.byte_140_nominal_signaling_rate_in_100_mbaud);

        j["Extended Rate Select Compliance"] =
            Extended_Rate_Select_ComplianceToJSON(programming.byte_141_extended_rate_select_compliance);
        ...
        j["Device & Transmitter Properties"] = Device_Technology_and_Transmitter_TechnologyToJSON(
            programming.byte_147_device_technology_and_transmitter_technology
        );

        j["Vendor Name"] = VendorNameToJSON(programming.byte_148_163_vendor_name);

        j["Extended Module Codes (Infiniband)"] =
            Extended_Module_CodesToJSON(programming.byte_164_extended_module_codes);
        ...
        j["Extended Specification Compliance Codes"] =
            ExtendedComplianceCodesToJSON(programming.byte_192_extended_specification_compliance_codes);

        j["Options"] = OptionsToJSON(
            programming.byte_193_option_values, programming.byte_194_option_values, programming.byte_195_option_values
        );
        ...
        j["Diagnostic Monitoring Type"] =
            Diagnostic_Monitoring_TypeToJSON(programming.byte_220_diagnostic_monitoring_type);

        j["Enhanced Options"] = Enhanced_OptionsToJSON(programming.byte_221_enhanced_options);

        j["Extended Baud Rate [MBaud] (Divisible by 250)"] =
            ExtendedBaudRate250MBaudToJSON(programming.byte_222_extended_baud_rate_in_250_mbaud);
    ...
    void SFF8636_Upper00hFromJSON(const nlohmann::json& j, SFF8636_Upper00h& programming) {
        ...
        programming.byte_131_ethernet_compliance_codes =
            _10_40G_100G_Ethernet_Compliance_CodesFromJSON(j.at("10/40G/100G Ethernet Compliance Codes"));
        programming.byte_132_sonet_compliance_codes = SONET_Compliance_CodesFromJSON(j.at("SONET Compliance Codes"));
        programming.byte_133_sas_sata_compliance_codes =
            SAS_SATA_Compliance_CodesFromJSON(j.at("SAS/SATA Compliance Codes"));
        programming.byte_134_gigabit_ethernet_compliance_codes =
            Gigabit_Ethernet_Compliance_CodesFromJSON(j.at("Gigabit Ethernet Compliance Codes"));
        auto fibreChannelPair = Fibre_Channel_Link_Length_And_Transmitter_TechnologyFromJSON(
            j.at("Fibre Channel Link Length"), j.at("Fibre Channel Transmitter Technology")
        );
        ...
        programming.byte_137_fibre_channel_transmission_media =
            Fibre_Channel_Transmission_MediaFromJSON(j.at("Fibre Channel Transmission Media"));
        ...
        programming.byte_140_nominal_signaling_rate_in_100_mbaud =
            NominalSignalingRate100MBaudFromJSON(j.at("Nominal Signaling Rate [MBaud] (Divisible by 100)"));

        programming.byte_141_extended_rate_select_compliance =
            Extended_Rate_Select_ComplianceJSON(j.at("Extended Rate Select Compliance"));
        ...
        programming.byte_145_length_om1_in_1m_or_copper_cable_attenuation_in_dB =
            copperOrFibreInfoToJSONReturn.byte_145_length_om1_in_1m_or_copper_cable_attenuation_in_dB;
        programming.byte_146_length_copper_in_1m_or_om4_in_2m =
            copperOrFibreInfoToJSONReturn.byte_146_length_copper_in_1m_or_om4_in_2m;
        programming.byte_186_wavelength_high_order_or_copper_attenuation =
            copperOrFibreInfoToJSONReturn.byte_186_wavelength_high_order_or_copper_attenuation;
        programming.byte_187_wavelength_low_order_or_copper_attenuation =
            copperOrFibreInfoToJSONReturn.byte_187_wavelength_low_order_or_copper_attenuation;
        programming.byte_188_wavelength_tolerance_high_order_or_copper_attenuation =
            copperOrFibreInfoToJSONReturn.byte_188_wavelength_tolerance_high_order_or_copper_attenuation;
        programming.byte_189_wavelength_tolerance_low_order_or_copper_attenuation =
            copperOrFibreInfoToJSONReturn.byte_189_wavelength_tolerance_low_order_or_copper_attenuation;

        programming.byte_147_device_technology_and_transmitter_technology =
            Device_Technology_and_Transmitter_TechnologyFromJSON(j.at("Device & Transmitter Properties"));

        programming.byte_148_163_vendor_name = VendorNameFromJSON(j.at("Vendor Name"));

        programming.byte_164_extended_module_codes =
            Extended_Module_CodesFromJSON(j.at("Extended Module Codes (Infiniband)"));
        ...
        programming.byte_192_extended_specification_compliance_codes =
        ...
        programming.byte_220_diagnostic_monitoring_type =
        ...
        programming.byte_222_extended_baud_rate_in_250_mbaud =
            ExtendedBaudRate250MBaudFromJSON(j.at("Extended Baud Rate [MBaud] (Divisible by 250)"));
        ...
        // Both are parsed before assembling because assembleToBinary reads byte_191_CC_BASE and
        // byte_223_CC_EXT, which are still uninitialised at this point. For an "auto" checksum 0x00
        // goes into the binary as a placeholder - CC_BASE covers bytes 128-190 and CC_EXT covers bytes
        // 192-222, so neither checksum includes its own byte and the placeholder cannot affect either result.
        const auto CC_BASEVal = CC_BASEChecksumFromJSON(j.at("CC_BASE"));
        const auto CC_EXTVal = CC_EXTChecksumFromJSON(j.at("CC_EXT"));

        programming.byte_191_CC_BASE = CC_BASEVal.value_or(0x00);
        programming.byte_223_CC_EXT = CC_EXTVal.value_or(0x00);
