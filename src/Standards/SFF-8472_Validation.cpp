...
namespace TransceiverTool::Standards::SFF8472::Validation {
    ...
    void validateIdentifierValues(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_0_Identifier >= 0x04 && programming.byte_0_Identifier <= 0x7F) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 0 (\"Identifier\") value corresponds to \"Not used by this specification\" / \"Reserved\" "
                    "range (SFF-8472 Rev 12.4 Table 5-1 \"Physical Device Identifier Values\"), value is {:#04x}",
                    programming.byte_0_Identifier
                )
            );
        }
        if(programming.byte_0_Identifier >= 0x80) {
            validationResult.warnings.push_back(
                fmt::format(
                    "Byte 0 (\"Identifier\") value corresponds to \"Vendor Specific\" range (SFF-8472 Rev 12.4 Table "
                    "5-1 \"Physical Device Identifier Values\"), value is {:#04x}",
                    programming.byte_0_Identifier
                )
            );
        }
    ...
    validateExtendedIdentifierValues(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_1_extended_identifier >= 0x08) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 1 (\"Extended Identifier\") value corresponds to \"Reserved\" range (SFF-8472 Rev 12.4 Table "
                    "5-2 \"Physical Device Extended Identifier Values\"), value is {:#04x}",
                    programming.byte_1_extended_identifier
                )
            );
        }
    }
    ...
    void validateConnectorTypes(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if((programming.byte_2_Connector_type >= 0x0E && programming.byte_2_Connector_type <= 0x1F) ||
           (programming.byte_2_Connector_type >= 0x29 && programming.byte_2_Connector_type <= 0x7F)) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 2 (\"Connector Type\") value corresponds to \"Reserved\" range (SFF-8024 Rev 4.11 Table 4-3 "
                    "\"Connector Types\"), value is {:#04x}",
        ...
        if(programming.byte_2_Connector_type >= 0x80) {
            validationResult.warnings.push_back(
                fmt::format(
                    "Byte 2 (\"Connector Type\") value corresponds to \"Vendor specific\" range (SFF-8024 Rev 4.11 "
    ...
    void validateSONETComplianceCodes(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_4_5_sonet_compliance_codes.reserved_byte_5_bit_7 ||
           programming.byte_4_5_sonet_compliance_codes.reserved_byte_5_bit_3) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 5 (\"SONET Compliance Codes\") value has at least one reserved bit set: Bit 7 {:d}, Bit 3 "
                    "{:d}",
                    programming.byte_4_5_sonet_compliance_codes.reserved_byte_5_bit_7,
                    programming.byte_4_5_sonet_compliance_codes.reserved_byte_5_bit_3
                )
            );
        }
    ...
    void validateSFPPlusCableTechnologyCodes(
        ...
        // SFF-8472 Rev 12.4 Table 5-3 Transceiver Compliance Codes
        if(programming.byte_8_sfp_plus_cable_technology_codes.reserved_bit_1 ||
           programming.byte_8_sfp_plus_cable_technology_codes.reserved_bit_0) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 8 (\"SFP+ Cable Technology\") value has at least one reserved bit set: Bit 1 {:d}, Bit 0 "
                    "{:d}",
                    programming.byte_8_sfp_plus_cable_technology_codes.reserved_bit_1,
                    programming.byte_8_sfp_plus_cable_technology_codes.reserved_bit_0
                )
            );
        }
    ...
    void validateFibreChannelTransmissionMediaCodes(
        ...
        if(programming.byte_9_fibre_channel_transmission_media_codes.reserved_bit_1) {
            validationResult.errors.push_back(
                fmt::format("Byte 9 (\"Fibre Channel Transmission Media\") has reserved bit 1 set")
            );
        }
    }
    ...
    void validateEncodingValues(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_11_Encoding >= 0x09) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 11 (\"Encoding\") value corresponds to \"Reserved\" range (SFF-8024 Rev 4.11 Table 4-2 "
                    "\"Encoding Values\"), value is {:#04x}",
    ...
    void validateSignalingRate(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_12_nominal_signaling_rate_in_100_mbaud == 0) {
            validationResult.warnings.push_back(fmt::format("Byte 12 (\"Nominal Signaling Rate\") value is 0"));
        }
        if(programming.byte_12_nominal_signaling_rate_in_100_mbaud == 0xFF) {
            if(programming.byte_66_max_signaling_rate_in_percent_or_nominal_signaling_rate_in_250_mbaud == 0) {
                validationResult.warnings.push_back(
                    fmt::format(
                        "Byte 12 (\"Nominal Signaling Rate\") value is 0xFF indicating a nominal baud rate > 25.4 GBd, "
                        "but Byte 66 (\"Extended Baud Rate: Nominal\") is zero"
                    )
                );
            } else {
                unsigned long nominalBaudRateFromByte66 =
                    (unsigned long)(programming
                ...
                if(nominalBaudRateFromByte66 < 25400) {
                    validationResult.warnings.push_back(
                        fmt::format(
                            "Byte 12 (\"Nominal Signaling Rate\") value is 0xFF indicating a nominal baud rate > 25.4 "
                            "GBd, but value from Byte 66 (\"Extended Baud Rate: Nominal\") is too small ({} MBd)",
                            nominalBaudRateFromByte66
                        )
                    );
                }
            }
    ...
    void validateRateIdentifier(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(byte == 0x03 || byte == 0x05 || byte == 0x07 || byte == 0x09 || byte == 0x0B || byte == 0x0D ||
           byte == 0x0F || byte == 0x11) {
            validationResult.warnings.push_back(
                fmt::format(
            ...
            if(!std::isprint(programming.byte_20_35_vendor_name[index])) {
                validationResult.errors.push_back(
                    fmt::format(
                        ...
                        20 + index,
                        index,
                        programming.byte_20_35_vendor_name[index]
                    )
                );
            }
        }
    ...
    void validateExtendedSpecificationComplianceCodes(
        ...
        if(programming.byte_36_extended_specification_compliance_codes == 0x0A ||
           programming.byte_36_extended_specification_compliance_codes == 0x0F ||
           (programming.byte_36_extended_specification_compliance_codes >= 0x3B &&
            programming.byte_36_extended_specification_compliance_codes <= 0x3E) ||
           (programming.byte_36_extended_specification_compliance_codes >= 0x4D &&
            programming.byte_36_extended_specification_compliance_codes <= 0x7E) ||
           programming.byte_36_extended_specification_compliance_codes >= 0x82) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 36 (\"Extended Specification Compliance Codes\") value corresponds to \"Reserved\" range / "
                    "value (SFF-8024 Rev 4.11 Table 4-4 \"Extended Specification Compliance Codes\"), value is {:#04x}",
    ...
    void validateVendorPartNumber(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        bool vendorPNAllZeros = std::all_of(
            programming.byte_40_55_vendor_pn.begin(), programming.byte_40_55_vendor_pn.end(), [](unsigned char val) {
                return val == 0;
            }
        );
        if(!vendorPNAllZeros) {
            for(int index = 0; index < programming.byte_40_55_vendor_pn.size(); ++index) {
                if(!std::isprint(programming.byte_40_55_vendor_pn[index])) {
                    validationResult.errors.push_back(
                        fmt::format(
                            "Byte {} (\"Vendor PN\", Position {}) is an unprintable ASCII character (Byte Value "
                            "{:#04x})",
                            40 + index,
                            index,
                            programming.byte_40_55_vendor_pn[index]
                        )
                    );
                }
            }
    ...
    void validateVendorRevisionNumber(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        bool vendorRevAllZeros = std::all_of(
            programming.byte_56_59_vendor_rev.begin(), programming.byte_56_59_vendor_rev.end(), [](unsigned char val) {
                return val == 0;
            }
        );
        if(!vendorRevAllZeros) {
            for(int index = 0; index < programming.byte_56_59_vendor_rev.size(); ++index) {
                if(!std::isprint(programming.byte_56_59_vendor_rev[index])) {
                    validationResult.errors.push_back(
                        fmt::format(
                            "Byte {} (\"Vendor Rev\", Position {}) is an unprintable ASCII character (Byte Value "
                            "{:#04x})",
                            56 + index,
                            index,
                            programming.byte_56_59_vendor_rev[index]
                        )
                    );
                }
            }
    ...
    void validateWavelengthOrCableSpecificationCompliance(
        ...
        if(programming.byte_8_sfp_plus_cable_technology_codes.Passive_Cable_bit_2 &&
           programming.byte_8_sfp_plus_cable_technology_codes.Active_Cable_bit_3) {
            validationResult.errors.push_back(
                "Both Passive Cable Compliance Bit (Byte 8, Bit 2) and Active Cable Compliance Bit (Byte 8, Bit 3) are "
                "set!"
            );
            return;
        }
        ...
        if(programming.byte_8_sfp_plus_cable_technology_codes.Passive_Cable_bit_2 &&
           !programming.byte_8_sfp_plus_cable_technology_codes.Active_Cable_bit_3) {
            ...
            if(programming.byte_60_wavelength_high_order_byte_or_cable_specification_compliance & 0b11111100) {
                validationResult.errors.push_back(
                    fmt::format(
                        "Byte 60 (\"Passive Cable Specification Compliance\") value has at least one reserved bit set: "
                        "Bit 7 {:d}, Bit 6 {:d}, Bit 5 {:d}, Bit 4 {:d}, Bit 3 {:d}, Bit 2 {:d}",
                        bool(
            ...
            if(programming.byte_61_wavelength_low_order_byte_or_cable_specification_compliance) {
                validationResult.errors.push_back(
                    fmt::format(
                        "Byte 61 (\"Passive Cable Specification Compliance\") value has at least one reserved bit set: "
                        "Bit 7 {:d}, Bit 6 {:d}, Bit 5 {:d}, Bit 4 {:d}, Bit 3 {:d}, Bit 2 {:d}, Bit 1 {:d}, Bit 0 "
                        "{:d}",
                        bool(
                        ...
                        bool(programming.byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 0))
                    )
                );
            }
        }
        if(!programming.byte_8_sfp_plus_cable_technology_codes.Passive_Cable_bit_2 &&
           programming.byte_8_sfp_plus_cable_technology_codes.Active_Cable_bit_3) {
            ...
            if(programming.byte_60_wavelength_high_order_byte_or_cable_specification_compliance & 0b11110000) {
                validationResult.errors.push_back(
                    fmt::format(
                        "Byte 60 (\"Active Cable Specification Compliance\") value has at least one reserved bit set: "
                        "Bit 7 {:d}, Bit 6 {:d}, Bit 5 {:d}, Bit 4 {:d}",
                        bool(
                            programming.byte_60_wavelength_high_order_byte_or_cable_specification_compliance & (1 << 7)
                        ),
                        bool(
            ...
            if(programming.byte_61_wavelength_low_order_byte_or_cable_specification_compliance) {
                validationResult.errors.push_back(
                    fmt::format(
                        "Byte 61 (\"Active Cable Specification Compliance\") value has at least one reserved bit set: "
                        "Bit 7 {:d}, Bit 6 {:d}, Bit 5 {:d}, Bit 4 {:d}, Bit 3 {:d}, Bit 2 {:d}, Bit 1 {:d}, Bit 0 "
                        "{:d}",
                        bool(
                            programming.byte_61_wavelength_low_order_byte_or_cable_specification_compliance & (1 << 7)
    ...
    void validateFibreChannelSpeed2ComplianceCodes(
        ...
        // SFF-8472 Rev 12.4 Table 5-3 Transceiver Compliance Codes
        if(programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_7 ||
           programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_6 ||
           programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_5 ||
           programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_4 ||
           programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_3 ||
           programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_2 ||
           programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_1) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 62 (\"Fibre Channel Speed 2\") value has at least one reserved bit set: Bit 7 {:d}, Bit 6 "
                    "{:d}, Bit 5 {:d}, Bit 4 {:d}, Bit 3 {:d}, Bit 2 {:d}, Bit 1 {:d}",
                    programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_7,
                    programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_6,
                    programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_5,
                    programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_4,
                    programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_3,
    ...
    void validateOptionValues(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        if(programming.byte_64_option_values.reserved_bit_7) {
            validationResult.errors.push_back("Byte 64 (\"Option Values\") value has reserved bit 7 set");
        }
        if(programming.byte_65_option_values.loss_of_signal_inverted_bit_2 &&
           programming.byte_65_option_values.loss_of_signal_implemented_bit_1) {
            validationResult.errors.push_back(
                "Byte 65 (\"Option Values\") value has both Loss of Signal implemented, signal inverted (Bit 2) and "
                "Loss of Signal implemented, behavior as defined in SFF-8419 (Bit 1) set"
            );
        }
        if(programming.byte_65_option_values.reserved_bit_0) {
            validationResult.errors.push_back("Byte 65 (\"Option Values\") value has reserved bit 0 set");
        }
    }
    ...
    void validateVendorSerialNumber(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        bool vendorSNAllZeros = std::all_of(
            programming.byte_68_83_vendor_sn.begin(), programming.byte_68_83_vendor_sn.end(), [](unsigned char val) {
                return val == 0;
            }
        );
        if(!vendorSNAllZeros) {
            for(int index = 0; index < programming.byte_68_83_vendor_sn.size(); ++index) {
                if(!std::isprint(programming.byte_68_83_vendor_sn[index])) {
                    validationResult.errors.push_back(
                        fmt::format(
                            "Byte {} (\"Vendor SN\", Position {}) is an unprintable ASCII character (Byte Value "
                            "{:#04x})",
                            68 + index,
                            index,
                            programming.byte_68_83_vendor_sn[index]
                        )
                    );
                }
            }
    ...
    void validateDateCode(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(!std::isdigit(programming.byte_84_91_date_code.year_low_order_digits[0]) ||
           !std::isdigit(programming.byte_84_91_date_code.year_low_order_digits[1])) {
            validationResult.errors.push_back(
                fmt::format("Byte 84 / 85 (\"Date Code\", low order digits of the year) is not a number")
            );
        }
        // No need to parse: We checked that both characters are numbers [0-9] and all values are valid (year 2000 -
        // 2099)

        if(programming.byte_84_91_date_code.month_digits[0] <= 0x2F ||
           programming.byte_84_91_date_code.month_digits[0] >= 0x3A ||
           programming.byte_84_91_date_code.month_digits[1] <= 0x2F ||
           programming.byte_84_91_date_code.month_digits[1] >= 0x3A) {
            validationResult.errors.push_back(
                fmt::format("Byte 86 / 87 (\"Date Code\", digits of the month) is not a number")
            );
        } else {
            try {
        ...
        if(programming.byte_84_91_date_code.day_digits[0] <= 0x2F ||
           programming.byte_84_91_date_code.day_digits[0] >= 0x3A ||
           programming.byte_84_91_date_code.day_digits[1] <= 0x2F ||
           programming.byte_84_91_date_code.day_digits[1] >= 0x3A) {
            validationResult.errors.push_back(
                fmt::format("Byte 88 / 89 (\"Date Code\", day of the month) is not a number")
            );
        } else {
            try {
                int digits_of_month = std::stoi(
        ...
        for(int index = 0; index < programming.byte_84_91_date_code.lot_code.size(); ++index) {
            if(!std::isprint(programming.byte_84_91_date_code.lot_code[index])) {
                validationResult.errors.push_back(
                    fmt::format(
                        "Byte {} (\"Vendor Lot Code\", Position {}) is an unprintable ASCII character (Byte Value "
                        "{:#04x})",
                        90 + index,
                        index,
                        programming.byte_84_91_date_code.lot_code[index]
                    )
                );
            }
        }
    ...
    validateDiagnosticMonitoringType(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        if(programming.byte_92_diagnostic_monitoring_type.reserved_bit_7 ||
           programming.byte_92_diagnostic_monitoring_type.reserved_bit_1 ||
           programming.byte_92_diagnostic_monitoring_type.reserved_bit_0) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 92 (\"Diagnostic Monitoring Type\") value has at least one reserved bit set: Bit 7 {:d}, Bit "
                    "1 {:d}, Bit 0 {:d}",
                    programming.byte_92_diagnostic_monitoring_type.reserved_bit_7,
                    programming.byte_92_diagnostic_monitoring_type.reserved_bit_1,
                    programming.byte_92_diagnostic_monitoring_type.reserved_bit_0
                )
            );
        ...
        if(programming.byte_92_diagnostic_monitoring_type.internally_calibrated_bit_5 &&
           programming.byte_92_diagnostic_monitoring_type.externally_calibrated_bit_4) {
            validationResult.errors.push_back(
                "Byte 92 (\"Diagnostic Monitoring Type\") value has both internally calibrated and externally "
                "calibrated bits set"
            );
        }
    }
    ...
    void validateEnhancedOptions(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        if(programming.byte_93_enhanced_options.reserved_bit_0) {
            validationResult.errors.push_back("Byte 93 (\"Enhanced Options\") value has reserved bit 0 set");
        }
    }
    ...
    void validateSFF8472Compliance(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        if(programming.byte_94_sff_8472_compliance == 0x0 || programming.byte_94_sff_8472_compliance >= 0x0A) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 94 (\"SFF-8472 Compliance\") value corresponds to \"Reserved\" range, value is {:#04x}",
                    programming.byte_94_sff_8472_compliance
                )
            );
        }
    }
    ...
    void validateCC_EXTChecksum(const SFF8472_LowerA0h& programming, common::ValidationResult& validationResult) {
        ...
        if(programming.byte_95_CC_EXT != correctChecksum) {
            validationResult.errors.push_back(
                fmt::format(
                    "Byte 95 (\"CC_EXT\") value is {:#04x}, but should be {:#04x}",
                    programming.byte_95_CC_EXT,
                    correctChecksum
                )
            );
        }
    ...
    // TODO: Introduce options to not warn on values in "Vendor Specific" ranges (in case this tool is used by an actual
    // vendor?)
    common::ValidationResult validateSFF8472_LowerA0h(
        const TransceiverTool::Standards::SFF8472::SFF8472_LowerA0h& programming
    ) {
        common::ValidationResult validationResult;
        ...
        // This section is so random and messed up that I'm not spending more time with it for the sake of my mental
        // health
