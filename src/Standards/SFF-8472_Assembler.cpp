...
namespace TransceiverTool::Standards::SFF8472 {
    ...
    void assembleToBinary(
        ...
        target[3] = (unsigned char)(programming.byte_3_ethernet_compliance_codes._10GBASE_ER_bit_7) << 7 |
        ...
        target[4] = (unsigned char)(programming.byte_4_escon_compliance_codes.ESCON_MMF_1310nm_LED_bit_7) << 7 |
                    ...
                    (unsigned char)(programming.byte_4_5_sonet_compliance_codes.OC_48_intermediate_reach_byte_4_bit_1)
                        << 1 |
        ...
        target[5] =
            ...
            (unsigned char)(programming.byte_4_5_sonet_compliance_codes.OC_12_single_mode_long_reach_2_byte_5_bit_6)
                << 6 |
            (unsigned char)(programming.byte_4_5_sonet_compliance_codes
                                .OC_12_single_mode_intermediate_reach_byte_5_bit_5)
                << 5 |
            ...
            (unsigned char)(programming.byte_4_5_sonet_compliance_codes
                                .OC_3_single_mode_intermediate_reach_byte_5_bit_1)
                << 1 |
            (unsigned char)(programming.byte_4_5_sonet_compliance_codes.OC_3_short_reach__byte_5_bit_0) << 0;


        target[6] = (unsigned char)(programming.byte_6_ethernet_compliance_codes.BASE_PX_bit_7) << 7 |
        ...
        target[7] =
            ...
            (unsigned char)(programming.byte_7_8_fibre_channel_technology_codes
                                .Shortwave_laser_linear_Rx_SA_byte_7_bit_2)
                << 2 |
            (unsigned char)(programming.byte_7_8_fibre_channel_technology_codes.Longwave_laser_LC_byte_7_bit_1) << 1 |
            (unsigned char)(programming.byte_7_8_fibre_channel_technology_codes
                                .Electrical_inter_enclosure_EL_byte_7_bit_0)
                << 0;


        target[8] =
            (unsigned char)(programming.byte_7_8_fibre_channel_technology_codes
                                .Electrical_intra_enclosure_EL_byte_byte_8_bit_7)
                << 7 |
            (unsigned char)(programming.byte_7_8_fibre_channel_technology_codes.Shortwave_laser_w_o_OFC_SN_byte_8_bit_6)
                << 6 |
            (unsigned char)(programming.byte_7_8_fibre_channel_technology_codes
                                .Shortwave_laser_with_OFC_SL_byte_8_bit_5)
                << 5 |
        ...
        target[9] =
            ...
            (unsigned char)(programming.byte_9_fibre_channel_transmission_media_codes.Multimode_50_um_M5_M5E_bit_2)
                << 2 |
        ...
        target[10] =
            ...
            (unsigned char)(programming.byte_10_fibre_channel_speed_codes.see_byte_62_fibre_channel_speed_2_bit_1)
                << 1 |
        ...
        target[62] = (unsigned char)(programming.byte_62_fibre_channel_2_speed_codes.reserved_bit_7) << 7 |
        ...
        target[92] =
            (unsigned char)(programming.byte_92_diagnostic_monitoring_type.reserved_bit_7) << 7 |
            (unsigned char)(programming.byte_92_diagnostic_monitoring_type
                                .digital_diagnostic_monitoring_implemented_bit_6)
                << 6 |
            ...
            (unsigned char)(programming.byte_92_diagnostic_monitoring_type.received_power_measurement_is_average_bit_3)
                << 3 |
        ...
        target[93] =
            (unsigned char)(programming.byte_93_enhanced_options.optional_alarm_warning_flags_implemented_bit_7) << 7 |
            (unsigned char)(programming.byte_93_enhanced_options
                                .optional_soft_TX_DISABLE_control_and_monitoring_implemented_bit_6)
                << 6 |
            (unsigned char)(programming.byte_93_enhanced_options.optional_soft_TX_FAULT_monitoring_implemented_bit_5)
                << 5 |
            (unsigned char)(programming.byte_93_enhanced_options.optional_soft_RX_LOS_monitoring_implemented_bit_4)
                << 4 |
            (unsigned char)(programming.byte_93_enhanced_options
                                .optional_soft_RATE_SELECT_control_and_monitoring_implemented_bit_3)
                << 3 |
            (unsigned char)(programming.byte_93_enhanced_options
                                .optional_application_select_control_implemented_per_SFF_8079_bit_2)
                << 2 |
            (unsigned char)(programming.byte_93_enhanced_options
                                .optional_soft_rate_select_control_implemented_per_SFF_8431_bit_1)
                << 1 |
